...
import { processJob } from "./background.js";
        ...
        async execute(args, exec) {
            ...
            if (args.run_in_background === true) {
                ...
                const id = jobs.start({
                    ...
                    run: () => processJob(signal => ctx.shell.start(ctx.shell.resolve({ ...request, signal })), proc => renderPwshProcessRead(proc.readOutput(), proc.sandbox, escalationModes)),
                });
