    ...
    const implementation = {
        ...
        async newSession(params, signal) {
            ...
            try {
                ...
                if (error instanceof AcpMcpConfigError)
        ...
        async setSessionConfigOption(params, signal) {
            ...
            try {
                ...
                if (error instanceof AcpModelConfigError)
                    throw invalidParams(error.message);
                throw error;
            }
        },
        async closeSession(params) {
            ...
            try {
                ...
                if (sessions.get(sessionId) === record)
                    sessions.delete(sessionId);
            }
            return {};
        },
...
function decodeSessionListCursor(value) {
    ...
    try {
        ...
        const createdAt = Array.isArray(decoded) ? decoded[0] : undefined;
        const sessionId = Array.isArray(decoded) ? decoded[1] : undefined;
