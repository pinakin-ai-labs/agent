...
import { assertReleasedV3Header, assertV3EventAdmission } from "./validation.js";
import { assertV3Event, assertV3StructuralRow } from "./payload.js";
                ...
                decoder.decodeRow(row, {
                    ...
                    emitEvent(event) {
                        ...
                        if (event.type === 'session/end-seed' && isSessionFormatJsonObject(event.data)
                            ...
                            acceptedInheritedCut = event.seq;
 ...
 */
export function assertV3RowAdmission(row) {
    assertV3StructuralRow(row);
    if (typeof row === 'object' && row !== null && !Array.isArray(row))
        assertV3EventAdmission(row);
}
