...
import { currentSessionMessageProjections } from "./message-projections.js";
/**
 ...
 */
export function validateInstalledCurrentSessionHeader(header) {
 ...
 * @returns nothing after successful validation.
 */
export function validateInstalledCurrentSessionArtifact(artifact) {
    if (artifact.header.version !== SESSION_FORMAT_VERSION) {
        throw new Error(`installed Session format is v${SESSION_FORMAT_VERSION}, got v${artifact.header.version}`);
    }
