...
import { releasedV0SessionFormatCodec, releasedV1SessionFormatCodec } from "../codec.js";
import { sessionFormatV0ToV1 } from "../migration.js";
import { assertReleasedV1Header } from "../validation.js";
import { assertReleasedV1Artifact, assertReleasedV1MigrationSource, } from "./validation.js";
const unusedEncoder = {
...
function restore(header, rows, recovery, validation) {
    const current = catalog.createRestore(header, { recovery, validation });
    for (const row of rows)
        current.decodeRow(row);
 ...
 */
export function restoreV0ToV1(header, rows, recovery = 'strict') {
 ...
 */
export function restoreV1(header, rows, recovery = 'strict') {
