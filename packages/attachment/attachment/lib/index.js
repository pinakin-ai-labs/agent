...
var AttachmentStore = class extends Service {
	...
	*/
	readImageRequest(ref, target, signal) {
		signal?.throwIfAborted();
...
//#endregion
export { AttachmentError, AttachmentId, AttachmentStore, AttachmentStore as default, ImageVariantId, admitEncodedFile, admitEncodedImages, isAttachmentError, isImageAdmissionError, longEdgeDimensions, requestImageDimensions };
