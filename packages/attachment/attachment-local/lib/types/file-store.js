...
import { publishImmutableAlias, publishImmutableObject, publishImmutableObjectStream, } from "./store.js";
 ...
 */
export function fileLeafName(value) {
    if (value === undefined)
        return 'file';
 ...
 */
export function storedFilePath(root, ref) {
 ...
 */
export async function saveFileVerbatim(root, input) {
 ...
 * @returns the durable content-addressed file reference.
 */
export async function saveFileStreamVerbatim(root, input) {
 ...
 */
export async function* readFileStreamVerbatim(root, ref, signal) {
