...
import { createProcessHarnessClient, HarnessClient, isRecord, SdkProtocolError } from "./client.js";
/**
...
export function createProcessDeepSeekHarness(runtime, options = {}) {
    const Constructor = DeepSeekHarness;
...
function isInboxReceipt(value, messageId) {
    if (!isRecord(value) || value.type !== 'agent/inbox/spliced' || !isRecord(value.data))
        return false;
