window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".q2rgRW_card{flex-direction:column;gap:8px;display:flex}.q2rgRW_row{align-items:center;min-height:32px;display:flex}.q2rgRW_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.q2rgRW_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.q2rgRW_separator{corner-shape:round;background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.q2rgRW_summary,.q2rgRW_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.q2rgRW_error{color:var(--dsw-alias-state-error-primary)}.q2rgRW_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.q2rgRW_card[data-cordis-status=awaiting-approval] .q2rgRW_status,.q2rgRW_card[data-cordis-status=client-pending] .q2rgRW_status{color:var(--dsw-alias-state-warn-label)}.q2rgRW_card[data-cordis-status=running] .q2rgRW_status{color:var(--dsw-alias-state-success-primary)}.q2rgRW_card[data-cordis-status=failed] .q2rgRW_status{color:var(--dsw-alias-state-error-primary)}.q2rgRW_inspect{corner-shape:round;width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.q2rgRW_card:hover .q2rgRW_inspect,.q2rgRW_inspect:focus-visible{opacity:1}.q2rgRW_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.q2rgRW_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.q2rgRW_business{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.q2rgRW_output{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.q2rgRW_business .q2rgRW_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"business": "q2rgRW_business",
			"card": "q2rgRW_card",
			"error": "q2rgRW_error",
			"icon": "q2rgRW_icon",
			"inspect": "q2rgRW_inspect",
			"message": "q2rgRW_message",
			"output": "q2rgRW_output",
			"row": "q2rgRW_row",
			"separator": "q2rgRW_separator",
			"status": "q2rgRW_status",
			"summary": "q2rgRW_summary",
			"title": "q2rgRW_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".fk2-4a_card{flex-direction:column;display:flex}.fk2-4a_card .fk2-4a_title,.fk2-4a_card .fk2-4a_chevron{color:var(--dsw-alias-state-business-primary)}.fk2-4a_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.fk2-4a_row{gap:0}.fk2-4a_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.fk2-4a_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.fk2-4a_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.fk2-4a_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.fk2-4a_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.fk2-4a_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.fk2-4a_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.fk2-4a_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.fk2-4a_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.fk2-4a_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.fk2-4a_switch{height:22px;padding:0 8px;font-size:12px}.fk2-4a_card[data-terminal] .fk2-4a_title,.fk2-4a_card[data-terminal] .fk2-4a_name,.fk2-4a_card[data-terminal] .fk2-4a_purpose,.fk2-4a_card[data-terminal] .fk2-4a_statusLabel{color:var(--dsw-alias-label-caption)}.fk2-4a_card[data-terminal] .fk2-4a_separator{background:var(--dsw-alias-label-caption)}.fk2-4a_bodyWrap{flex-direction:column;display:flex}.fk2-4a_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.fk2-4a_sourceTabs{border-bottom:.5px solid var(--dsw-alias-border-l2);height:32px;display:flex}.fk2-4a_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.fk2-4a_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.fk2-4a_sourceTab:disabled{cursor:default;opacity:.4}.fk2-4a_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.fk2-4a_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.fk2-4a_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.fk2-4a_sourcePanel{max-height:260px;overflow:auto}.fk2-4a_sourceCode{margin:0}.fk2-4a_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.fk2-4a_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.fk2-4a_output{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.fk2-4a_output[data-error]{color:var(--dsw-alias-state-error-primary)}.fk2-4a_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.fk2-4a_card:hover .fk2-4a_inspectButton,.fk2-4a_inspectButton:focus-visible{opacity:1}.fk2-4a_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.fk2-4a_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.fk2-4a_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"approvalPrompt": "fk2-4a_approvalPrompt",
			"bodyWrap": "fk2-4a_bodyWrap",
			"card": "fk2-4a_card",
			"chevron": "fk2-4a_chevron",
			"codeSection": "fk2-4a_codeSection",
			"errorSummary": "fk2-4a_errorSummary",
			"inspectButton": "fk2-4a_inspectButton",
			"name": "fk2-4a_name",
			"notice": "fk2-4a_notice",
			"output": "fk2-4a_output",
			"panelHint": "fk2-4a_panelHint",
			"purpose": "fk2-4a_purpose",
			"readout": "fk2-4a_readout",
			"requestError": "fk2-4a_requestError",
			"row": "fk2-4a_row",
			"sectionLabel": "fk2-4a_sectionLabel",
			"separator": "fk2-4a_separator",
			"sourceCard": "fk2-4a_sourceCard",
			"sourceCode": "fk2-4a_sourceCode",
			"sourcePanel": "fk2-4a_sourcePanel",
			"sourceTab": "fk2-4a_sourceTab",
			"sourceTabActive": "fk2-4a_sourceTabActive",
			"sourceTabs": "fk2-4a_sourceTabs",
			"statusLabel": "fk2-4a_statusLabel",
			"switch": "fk2-4a_switch",
			"title": "fk2-4a_title",
			"visuallyHidden": "fk2-4a_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".fTv9Wq_layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}.fTv9Wq_footerButtons{align-items:center;width:100%;display:flex}.fTv9Wq_badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.fTv9Wq_badge:hover,.fTv9Wq_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.fTv9Wq_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.fTv9Wq_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.fTv9Wq_layer.fTv9Wq_rail{width:36px;height:36px;margin:0}.fTv9Wq_rail .fTv9Wq_badge{corner-shape:round;border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.fTv9Wq_rail .fTv9Wq_footerButtons{flex-direction:column;gap:2px}.fTv9Wq_panel{z-index:30;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:12px;flex-direction:column;display:flex;position:fixed;overflow:hidden}.fTv9Wq_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.fTv9Wq_body{flex:1;min-height:0;padding:0 12px 12px;overflow-y:auto}.fTv9Wq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:20px}.fTv9Wq_note,.fTv9Wq_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.fTv9Wq_readError{color:var(--dsw-alias-state-error-primary)}.fTv9Wq_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0;font-size:11px;font-weight:500;line-height:16px}.fTv9Wq_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.fTv9Wq_row{border:.5px solid var(--dsw-alias-border-l4);border-radius:12px;flex-direction:column;gap:8px;padding:14px 12px 10px;display:flex}.fTv9Wq_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.fTv9Wq_rowHead{align-items:center;gap:8px;display:flex}.fTv9Wq_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.fTv9Wq_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.fTv9Wq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.fTv9Wq_row[data-cordis-status=idle] .fTv9Wq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.fTv9Wq_row[data-cordis-status=awaiting-approval] .fTv9Wq_rowStatus,.fTv9Wq_row[data-cordis-status=client-pending] .fTv9Wq_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.fTv9Wq_row[data-cordis-status=failed] .fTv9Wq_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.fTv9Wq_row[data-cordis-status=running] .fTv9Wq_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.fTv9Wq_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.fTv9Wq_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.fTv9Wq_versionPicker select{border:.5px solid var(--dsw-alias-border-l3);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border-radius:7px;flex:1;padding:0 8px}.fTv9Wq_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.fTv9Wq_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.fTv9Wq_rowActions{flex:none;align-items:center;gap:10px;display:flex}.fTv9Wq_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.fTv9Wq_transitionActions{gap:6px;margin-left:auto;display:flex}.fTv9Wq_transitionActions button{border:.5px solid var(--dsw-alias-border-l3);corner-shape:round;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.fTv9Wq_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.fTv9Wq_transitionActions button:disabled{opacity:.4;cursor:default}.fTv9Wq_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.fTv9Wq_actionButton{corner-shape:round;width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.fTv9Wq_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.fTv9Wq_actionButton:disabled{opacity:.4;cursor:default}.fTv9Wq_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.fTv9Wq_doubleCheck svg{position:absolute;top:1px}.fTv9Wq_doubleCheck svg:first-child{opacity:.7;left:0}.fTv9Wq_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"actionButton": "fTv9Wq_actionButton",
			"activeVersion": "fTv9Wq_activeVersion",
			"badge": "fTv9Wq_badge",
			"badgeCount": "fTv9Wq_badgeCount",
			"badgeLabel": "fTv9Wq_badgeLabel",
			"body": "fTv9Wq_body",
			"doubleCheck": "fTv9Wq_doubleCheck",
			"footerButtons": "fTv9Wq_footerButtons",
			"group": "fTv9Wq_group",
			"header": "fTv9Wq_header",
			"layer": "fTv9Wq_layer",
			"note": "fTv9Wq_note",
			"panel": "fTv9Wq_panel",
			"rail": "fTv9Wq_rail",
			"readError": "fTv9Wq_readError",
			"row": "fTv9Wq_row",
			"rowActions": "fTv9Wq_rowActions",
			"rowDetail": "fTv9Wq_rowDetail",
			"rowError": "fTv9Wq_rowError",
			"rowHead": "fTv9Wq_rowHead",
			"rowId": "fTv9Wq_rowId",
			"rowName": "fTv9Wq_rowName",
			"rowPurpose": "fTv9Wq_rowPurpose",
			"rowStatus": "fTv9Wq_rowStatus",
			"rows": "fTv9Wq_rows",
			"title": "fTv9Wq_title",
			"transition": "fTv9Wq_transition",
			"transitionActions": "fTv9Wq_transitionActions",
			"versionPicker": "fTv9Wq_versionPicker"
		};
		//#endregion
