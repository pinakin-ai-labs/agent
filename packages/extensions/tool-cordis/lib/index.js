...
const SERVICE_API = [
		...
		methods: [
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "source",
						description: "fresh creation, resume, clear, or compaction source."
					},
					{
						name: "signal",
						description: "optional factory initialization cancellation signal passed to listeners."
					}
				],
		...
		methods: [
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "target",
						description: "route-chosen dimensions and byte target; an unmet byte target yields the smallest ladder output."
					},
					{
						name: "signal",
	...
	},
	{
		...
		methods: [{
			...
			parameters: [{
				name: "name",
				description: "provider-owned name used in registration diagnostics."
			}],
	...
	},
	{
		...
		methods: [{
			...
			parameters: [{
				name: "server",
				description: "configured server name, unique in this scope."
			}, {
				name: "provider",
				description: "connection-owned resource operations."
			}],
			returns: "the effect disposer for this exact registration."
		}]
	},
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "admit",
					description: "synchronous gate run before live Auto selection or restore."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "name",
					description: "a configured preset key, live `auto`, or `custom`."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "Program, bindings, cancellation and optional execution choices."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "spec",
					description: "directory, deadline, program, bindings, cancellation and supported policy."
				}],
	...
	},
	{
		...
		methods: [{
			...
			parameters: [
				...
				{
					name: "signal",
					description: "cancellation while the provider resolves the policy and runner."
				}
			],
		...
		methods: [
			{
				...
				parameters: [{
					name: "projection",
					description: "pure definition owned by the event's plugin."
				}],
		...
		methods: [
			...
			},
			{
				...
				parameters: [
					{
						name: "method",
						description: "the private helper operation."
					},
					{
						name: "params",
						description: "JSON request fields validated by the helper."
					},
					{
						name: "result",
						description: "response validation before returning provider-visible data."
					},
					{
						name: "signal",
						description: "cancellation, which does not undo completed remote effects."
					},
					{
						name: "wait",
						description: "allow a process observation to outlast the administrative deadline."
					}
				],
			...
			},
			{
				...
				parameters: [{
					name: "endpoint",
					description: "private coordinates issued by this connection's helper."
				}, {
					name: "signal",
					description: "cancellation of allocation and the resulting socket."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "signal",
					description: "cancellation of remote environment inspection."
				}],
		...
		methods: [
			{
				...
				parameters: [{
					name: "agent",
					description: "Session owner supplied by the Gateway."
				}, {
					name: "signal",
			...
			},
			{
				...
				parameters: [{
					name: "sessionId",
					description: "displayed Session identity, including offline history."
				}],
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "request",
						description: "initial dimensions and idempotency identity."
					},
					{
						name: "signal",
						description: "allocation cancellation; committed terminals survive disconnection."
					}
				],
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "attachmentId",
						description: "new exclusive input attachment."
					},
					{
						name: "signal",
						description: "physical stream cancellation."
					}
				],
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "attachmentId",
						description: "current writable attachment."
					},
					{
						name: "data",
						description: "input bytes represented as UTF-8 text."
					}
				],
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "title",
						description: "nonempty display title, at most 120 characters."
					}
				]
			},
			{
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "Session identity to unarchive."
				}],
				returns: "the complete resulting archive set."
			},
			{
...
const EVENT_API = [
	...
	},
	{
		...
		parameters: [{
			name: "payload",
			description: ".signal - factory initialization cancellation signal, when provided. Scope-filtered dispatch (`@deepseek-ai/dsh-scope`): agent-scoped listeners receive only that agent."
		}]
	},
	{
		name: "agent/disposed",
	...
	},
	{
		...
		parameters: [{
			name: "payload",
			description: ".signal - optional compaction cancellation signal."
		}, {
			name: "next",
			description: "delegate to the next recovery listener."
		}]
	},
	{
