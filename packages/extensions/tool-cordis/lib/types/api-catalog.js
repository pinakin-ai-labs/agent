 ...
 */
export function queryServiceApi(key, services = SERVICE_API) {
    if (key === undefined) {
        return {
            mode: 'catalog',
    ...
    if (service === undefined)
        throw new Error(`no catalogued Service named "${key}"`);
    return {
        mode: 'service',
        service: {
            key: service.key,
 ...
 */
export function queryEventApi(name, events = EVENT_API) {
    if (name === undefined) {
        return {
            mode: 'catalog',
