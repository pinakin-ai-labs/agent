...
const _deepseek_ai_dsh_subagent_subagents_list_parameter_0$schema = () => (_deepseek_ai_dsh_subagent_subagents_list_parameter_0$schema$value ??= z.intersection(z.string(), z.unknown()))
let _deepseek_ai_dsh_subagent_subagents_list_result$schema$value
const _deepseek_ai_dsh_subagent_subagents_list_result$schema = () => (_deepseek_ai_dsh_subagent_subagents_list_result$schema$value ??= z.object({
