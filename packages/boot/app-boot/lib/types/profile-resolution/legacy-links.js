 ...
 */
export function isPackagedExecutable() {
 ...
 */
export function canonicalLinkPath(path) {
    try {
 ...
 */
export function symlinkPointsTo(link, target) {
 ...
 */
export function isProfileModuleFallbackLink(profileDir, packageName) {
...
//# sourceMappingURL=legacy-links.js.map