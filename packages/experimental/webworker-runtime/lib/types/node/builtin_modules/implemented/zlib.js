...
export const zstdCompressSync = notImplementedFail(MODULE, 'zstdCompressSync');
/** One-shot Zstandard decompression (unavailable; the worker never reads compressed logs). */
export const zstdDecompressSync = notImplementedFail(MODULE, 'zstdDecompressSync');
/** Callback form of {@link zstdCompressSync} (`promisify`'d at module scope by the backend). */
export const zstdCompress = notImplementedFail(MODULE, 'zstdCompress');
/** Callback form of {@link zstdDecompressSync}. */
export const zstdDecompress = notImplementedFail(MODULE, 'zstdDecompress');
/**
...
export const createZstdCompress = notImplementedFail(MODULE, 'createZstdCompress');
/** gzip family (unavailable; no consumer in the reachable tree). */
export const gzip = notImplementedFail(MODULE, 'gzip');
/** gzip sync counterpart. */
export const gzipSync = notImplementedFail(MODULE, 'gzipSync');
/** gunzip counterpart. */
export const gunzip = notImplementedFail(MODULE, 'gunzip');
/** gunzip sync counterpart. */
export const gunzipSync = notImplementedFail(MODULE, 'gunzipSync');
