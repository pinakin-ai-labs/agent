 ...
 */
export declare function notImplementedFail<Face = (...args: never[]) => never>(module: string, symbol: string): Face;
/**
 ...
 */
export declare function notAvailableError(module: string, symbol: string): Error;
//# sourceMappingURL=notImplementedFail.d.ts.map