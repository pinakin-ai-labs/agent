...
export declare const DEFAULT_ROOT = "/dsh";
/**
 ...
 */
export declare const IMAGE_FILE_NAME = "vfs-image.tar.gz";
/** Image path the composed profile is written to; the runtime's Loader reads it. */
export declare const IMAGE_CONFIG_PATH = "config/cordis.yml";
/** Image path of the manifest the runtime reads before it wraps a single module. */
export declare const IMAGE_MANIFEST_PATH = "config/vfs-manifest.json";
/** Home directory under the root; the process shim's `DSH_HOME`/`HOME` default. */
export declare const IMAGE_HOME_DIRECTORY = "home";
/** Working directories the host tree expects to exist, empty. */
export declare const IMAGE_EMPTY_DIRECTORIES: readonly string[];
/**
 ...
 */
export declare const IMAGE_OVERLAY_DIRECTORIES: readonly string[];
/**
 ...
 */
export declare const LOWERING_VERSION = "dsh-worker-transform/1";
/**
 ...
 */
export declare const WRAPPER_PARAMS: readonly ["exports", "require", "module", "__filename", "__dirname", "__dsh$meta", "__als"];
//# sourceMappingURL=image-layout.d.ts.map