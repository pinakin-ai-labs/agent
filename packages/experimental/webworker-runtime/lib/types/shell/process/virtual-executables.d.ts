...
export type VirtualExecutableSyncResult = VirtualExecutableExit | {
...
export interface VirtualExecutable {
     ...
     */
    prepare(args: readonly string[], context: {
        readonly cwd: string;
        readonly filesystem: ShellFileSystem;
 ...
 */
export declare function virtualExecutable(path: string): VirtualExecutable | undefined;
//# sourceMappingURL=virtual-executables.d.ts.map