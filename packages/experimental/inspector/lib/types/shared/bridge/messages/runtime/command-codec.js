...
import { exactKeys, optionalBoolean, optionalNonNegativeNumber, optionalString, wireId } from "../../../validation.js";
/**
 ...
 */
export function parseClientRuntimeCommand(value) {
    ...
    switch (value.op) {
        case 'evaluate': {
            ...
            if (typeof value.expression !== 'string')
                throw new Error('inspector protocol: evaluate expression must be a string');
            return {
                op: 'evaluate',
        ...
        case 'release-object-group':
            ...
            if (typeof value.objectGroup !== 'string')
                throw new Error('inspector protocol: objectGroup must be a string');
...
function parseCallFunction(value) {
    ...
    if (value.arguments !== undefined) {
        if (!Array.isArray(value.arguments))
            throw new Error('inspector protocol: call arguments must be an array');
    ...
    return {
        ...
        ...(value.receiver === undefined
            ? {}
            : { receiver: wireId(value.receiver, 'receiver') }),
    ...
    switch (value.kind) {
        case 'value':
            ...
            if (!isJsonValue(value.value))
                throw new Error('inspector protocol: call argument value must be JSON');
            return { kind: 'value', value: value.value };
        case 'unserializable':
            exactKeys(value, ['kind', 'value'], 'unserializable call argument');
            if (typeof value.value !== 'string')
                throw new Error('inspector protocol: unserializable argument must be a string');
...
//# sourceMappingURL=command-codec.js.map