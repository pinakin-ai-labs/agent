...
import type { RuntimeExceptionDetails, RuntimeInternalPropertyDescriptor, RuntimeCallArgument, RuntimeAwaitPromiseRequest, RuntimeCallFunctionRequest, RuntimeCompletion, RuntimeEvaluateRequest, RuntimeGetPropertiesRequest, RuntimePropertyDescriptor, RuntimeRemoteObject } from '../../../cdp/index.ts';
...
export type ClientRuntimeCommand = ClientRuntimeEvaluateCommand | ClientRuntimeGetPropertiesCommand | ClientRuntimeCallFunctionCommand | ClientRuntimeAwaitPromiseCommand | ClientRuntimeReleaseObjectCommand | ClientRuntimeReleaseObjectGroupCommand | ClientRuntimeGlobalLexicalScopeNamesCommand;
...
export type ClientRuntimeResult = {
    readonly op: 'evaluate';
    readonly completion: ClientRuntimeCompletion;
} | {
    readonly op: 'get-properties';
