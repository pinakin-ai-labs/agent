...
export type CdpNumericId<Role extends string> = number & {
    readonly [cdpNumericIdBrand]: Role;
};
 ...
 */
export declare function cdpStringId<Role extends string>(value: string, label: string): InspectorId<Role>;
/**
 ...
 */
export declare function cdpNumericId<Role extends string>(value: number, label: string): CdpNumericId<Role>;
export {};
