...
import { z } from 'zod';
import { browserInputs, openNativeBrowser, stagehandModelSchema } from "./native.js";
import { answer } from "./worker-rpc.js";
const port = parentPort;
if (port === null)
    throw new Error('Stagehand attachment requires a Worker parent');
...
void opening.catch((error) => { void error; });
port.on('message', (raw) => {
