 ...
 */
export declare const EXCLUDE: readonly string[];
/**
 ...
 */
export declare const EXCLUDE_WORKSPACE: readonly string[];
/**
 ...
 */
export declare const PAGE_ASSETS: readonly string[];
/**
 ...
 * `worker-host.ts`.
 */
export declare const IMAGE_ENTRY_SEEDS: readonly string[];
