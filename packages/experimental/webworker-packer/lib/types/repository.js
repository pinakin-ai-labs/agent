 ...
 */
export function configTrees(repoRoot) {
 ...
 */
export function previewFixtures(repoRoot) {
 ...
 */
export function describePack(result, repoRoot, outputFile) {
    const sizeOf = (prefix) => Object.entries(result.files)
