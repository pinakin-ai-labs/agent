...
export const processIdSchema = z.uuid().transform((value) => value);
/** Admit a text iterator identity from the private helper protocol. */
export const textStreamIdSchema = z.uuid().transform((value) => value);
 ...
 */
export function outputSnapshotFrameLimit(maxBytes) {
