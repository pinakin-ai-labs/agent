...
import type { TypertClientRemote, RemoteFailure, RemoteResult } from '@deepseek-ai/dsh-typert-protocol';
 ...
 */
export declare function carrierFailure(endpoint: string, error: unknown): Extract<RemoteResult<never>, {
    readonly ok: false;
}>;
/**
 ...
 * @returns the failed result.
 */
export declare function cancelledFailure(endpoint: string, cause: unknown): Extract<RemoteResult<never>, {
    readonly ok: false;
}>;
/**
