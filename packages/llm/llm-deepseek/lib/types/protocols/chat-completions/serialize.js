...
function assertRetainedImagesFit(messages, images) {
    ...
    if (offloadImages > 0) {
        throw new LlmError(`DeepSeek ${representation} request images exceed the route budget; ${offloadImages} more oldest occurrence(s) must be offloaded.`, IMAGE_OFFLOAD_REQUIRED_CODE, { offloadImages });
    }
}
/**
