...
export { Config, resolveAdapterOptions, PUBLIC_BASE_URL, MESSAGES_BASE_URL } from "./config.js";
...
export { DEFAULT_LOW_DETAIL_IMAGE_PIXEL_BUDGET, DEFAULT_MAX_IMAGES_PER_REQUEST, DEFAULT_MAX_REQUEST_FILES_BYTES, DEFAULT_REQUEST_IMAGE_MAX_BYTES, REQUEST_IMAGE_MAX_DIMENSION, deepSeekImageRequestPricing, resolveRequestImageMaxBytes, resolveRequestImageTarget, } from "./common/request-pricing.js";
export { deepSeekImageTokens, deepSeekRequestImageDimensions } from "./common/image-tokens.js";
export { DeepSeekFileStore, MAX_IMAGE_BYTES } from "./common/file-store.js";
export { DeepSeekFilesClient, MAX_FILE_EXPIRY_SECONDS, MAX_FILE_UPLOAD_BYTES, MAX_STORED_FILE_BYTES, MAX_STORED_FILE_COUNT, MIN_FILE_EXPIRY_SECONDS } from "./common/files-api.js";
export { DeepSeekFileId } from "./common/file-id.js";
export { DeepSeekUploadIndex, deepSeekFileScope } from "./common/upload-index.js";
...
export function apply(ctx, config) {
    ...
    const resolveApiKey = async (connection) => {
        ...
        if (credentials !== undefined) {
            ...
            if (hit !== undefined)
                return assertUsableApiKey(hit.value, 'llm-deepseek', ref);
        }
        else {
        ...
        throw new LlmError(`llm-deepseek: no API key for provider route "${PROVIDER}"; store ${ref} through the credentials`
