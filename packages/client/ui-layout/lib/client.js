window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".abh_Pa_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.abh_Pa_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.abh_Pa_frame{transition:none}}.abh_Pa_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:.5px solid var(--dsw-alias-border-l3);min-width:0;overflow:hidden}.abh_Pa_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.abh_Pa_handle{cursor:col-resize;z-index:11;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.abh_Pa_frame[data-dragging] .abh_Pa_handle,.abh_Pa_frame[data-rightbar-fullscreen],.abh_Pa_frame[data-rightbar-fullscreen] .abh_Pa_handle,.abh_Pa_frame[data-rightbar-instant],.abh_Pa_frame[data-rightbar-instant] .abh_Pa_handle{transition:none}@media (prefers-reduced-motion:reduce){.abh_Pa_handle{transition:none}}.abh_Pa_rightbarCol{min-width:0;position:relative;overflow:visible}.abh_Pa_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.abh_Pa_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "abh_Pa_centerCol",
			"frame": "abh_Pa_frame",
			"handle": "abh_Pa_handle",
			"overlayLayer": "abh_Pa_overlayLayer",
			"rightbarCol": "abh_Pa_rightbarCol",
			"sidebarCol": "abh_Pa_sidebarCol"
		};
		//#endregion
