...
export function ReferenceChip({ label, appearance, invalid }) {
    return (_jsxs("span", { className: clsx(referenceCss.reference, css.chip, appearance === 'file' && !invalid && referenceCss.openable, invalid && css.invalid), title: label, children: [appearance === undefined
