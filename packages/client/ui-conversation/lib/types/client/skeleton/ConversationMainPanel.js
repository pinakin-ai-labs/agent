 ...
 */
export function ConversationMainPanel(props) {
    ...
    return (_jsxs("div", { ref: rootResizeRef, className: css.root, "data-phase": phase, children: [sessionId === undefined ? null : renderSlot('conversation.session.header', {}), _jsx(ConversationContent, { ...props, session: session, phase: phase, hero: hero, onHandleStart: onHandleStart, onHandleDrag: onHandleDrag, onHandleCommit: onHandleCommit, onHandleEnd: onHandleEnd })] }));
}
//# sourceMappingURL=ConversationMainPanel.js.map