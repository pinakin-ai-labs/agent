window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/MessageItem.module.css.mjs
		const css$15 = ".DkAxsq_userRow{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.DkAxsq_userStack{min-width:0;max-width:min(calc(var(--dsh-chat-content-width,748px) * .702), 82%);flex-direction:column;align-items:flex-end;gap:8px;display:flex}.DkAxsq_bubble{background:var(--dsw-specific-bubble);max-width:100%;font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:22px;padding:10px 16px}.DkAxsq_referenceSummary{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.DkAxsq_contextRow{padding:2px 0}.DkAxsq_compactionRow{--dsh-compaction-header-height:calc(24px + var(--dsh-content-font-delta,0px));padding:2px 0}.DkAxsq_compactionButton{width:100%;height:var(--dsh-compaction-header-height);min-width:0;color:inherit;font:inherit;text-align:left;background:0 0;border:none;border-radius:6px;align-items:center;padding:0;display:flex}.DkAxsq_compactionRow:has(.DkAxsq_compactionBody) .DkAxsq_compactionButton{z-index:7;background:var(--dsw-alias-bg-base);border-radius:0;position:sticky;top:0}.DkAxsq_compactionBody :has(>[data-code-block-banner]){top:var(--dsh-compaction-header-height)}.DkAxsq_compactionRow:has(.DkAxsq_compactionBody) .DkAxsq_compactionButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.DkAxsq_compactionButton:not(:disabled){cursor:pointer}.DkAxsq_compactionButton:not(:disabled):hover{background:var(--dsw-alias-interactive-bg-hover)}.DkAxsq_compactionLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none;place-items:center;margin-right:6px;display:inline-grid}.DkAxsq_compactionLeading svg{width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.DkAxsq_compactionContextIcon,.DkAxsq_compactionDisclosureIcon{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}.DkAxsq_compactionDisclosureIcon,.DkAxsq_compactionButton:not(:disabled):hover .DkAxsq_compactionContextIcon,.DkAxsq_compactionButton:not(:disabled):focus-visible .DkAxsq_compactionContextIcon{opacity:0}.DkAxsq_compactionButton:not(:disabled):hover .DkAxsq_compactionDisclosureIcon,.DkAxsq_compactionButton:not(:disabled):focus-visible .DkAxsq_compactionDisclosureIcon{opacity:1}.DkAxsq_compactionTitle{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary-dimmed);flex:none}.DkAxsq_compactionSep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.DkAxsq_compactionSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.DkAxsq_compactionBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}.DkAxsq_retryRow{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px))}.DkAxsq_retrySummary{width:fit-content;color:inherit;cursor:pointer;user-select:none;border-radius:3px;align-items:center;gap:7px;padding:2px 0;list-style:none;display:inline-flex}.DkAxsq_retrySummary::-webkit-details-marker{display:none}.DkAxsq_retrySummary:after{content:\"\";opacity:.8;border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;transform:rotate(-45deg)}.DkAxsq_retrySummary:hover{color:var(--dsw-alias-label-secondary)}.DkAxsq_retrySummary:focus-visible{outline:1.5px solid var(--dsw-alias-button-info-fill);outline-offset:2px}.DkAxsq_retryText{color:inherit}.DkAxsq_retryRow[data-active] .DkAxsq_retryText{background:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-tertiary) 40%, var(--dsw-alias-label-secondary) 50%, var(--dsw-alias-label-tertiary) 60%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-position:100%;background-size:200% 100%;background-clip:text;animation:1.6s ease-in-out infinite DkAxsq_retry-shimmer}.DkAxsq_retryRow[open] .DkAxsq_retrySummary:after{transform:rotate(45deg)}.DkAxsq_retryDetails{overflow-wrap:anywhere;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));gap:2px;margin-top:3px;padding-left:14px;display:grid}.DkAxsq_retryDetailLabel{color:var(--dsw-alias-label-secondary)}.DkAxsq_turnErrorRow{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));grid-template-columns:10px minmax(0,1fr) auto;align-items:start;gap:8px;padding:2px 0;display:grid}.DkAxsq_turnErrorDot{margin-top:5px}.DkAxsq_turnErrorCopy{overflow-wrap:anywhere;min-width:0}.DkAxsq_turnErrorTitle{color:var(--dsw-alias-state-error-primary);margin-right:6px;font-weight:600}.DkAxsq_turnErrorMessage{color:var(--dsw-alias-label-secondary)}.DkAxsq_turnErrorCode{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-markdown-code-block-small)}.DkAxsq_maxTokensTitle{color:var(--dsw-alias-state-warn-primary);margin-right:6px;font-weight:600}@keyframes DkAxsq_retry-shimmer{0%{background-position:100%}to{background-position:0}}@media (prefers-reduced-motion:reduce){.DkAxsq_retryRow[data-active] .DkAxsq_retryText{color:inherit;background:0 0;animation:none}}.DkAxsq_attachmentRow{flex-wrap:wrap;justify-content:flex-end;gap:8px;max-width:100%;display:flex}.DkAxsq_fileCard{border:.5px solid var(--dsw-alias-border-l2,#0000001f);background:var(--dsw-specific-input-major,transparent);box-sizing:border-box;border-radius:16px;flex:0 0 240px;align-items:center;gap:10px;width:240px;min-height:64px;padding:8px 12px;display:inline-flex}.DkAxsq_fileIcon{flex:none;width:28px;height:28px}.DkAxsq_fileContent{flex-direction:column;flex:1;min-width:0;display:flex}.DkAxsq_fileName{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px;overflow:hidden}.DkAxsq_fileMeta{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-tertiary,#00000073);font-size:12px;line-height:15px;overflow:hidden}";
		...
		var MessageItem_module_css_default = {
			"attachmentRow": "DkAxsq_attachmentRow",
			"bubble": "DkAxsq_bubble",
			"compactionBody": "DkAxsq_compactionBody",
			"compactionButton": "DkAxsq_compactionButton",
			"compactionContextIcon": "DkAxsq_compactionContextIcon",
			"compactionDisclosureIcon": "DkAxsq_compactionDisclosureIcon",
			"compactionLeading": "DkAxsq_compactionLeading",
			"compactionRow": "DkAxsq_compactionRow",
			"compactionSep": "DkAxsq_compactionSep",
			"compactionSummary": "DkAxsq_compactionSummary",
			"compactionTitle": "DkAxsq_compactionTitle",
			"contextRow": "DkAxsq_contextRow",
			"fileCard": "DkAxsq_fileCard",
			"fileContent": "DkAxsq_fileContent",
			"fileIcon": "DkAxsq_fileIcon",
			"fileMeta": "DkAxsq_fileMeta",
			"fileName": "DkAxsq_fileName",
			"maxTokensTitle": "DkAxsq_maxTokensTitle",
			"referenceSummary": "DkAxsq_referenceSummary",
			"retry-shimmer": "DkAxsq_retry-shimmer",
			"retryDetailLabel": "DkAxsq_retryDetailLabel",
			"retryDetails": "DkAxsq_retryDetails",
			"retryRow": "DkAxsq_retryRow",
			"retrySummary": "DkAxsq_retrySummary",
			"retryText": "DkAxsq_retryText",
			"turnErrorCode": "DkAxsq_turnErrorCode",
			"turnErrorCopy": "DkAxsq_turnErrorCopy",
			"turnErrorDot": "DkAxsq_turnErrorDot",
			"turnErrorMessage": "DkAxsq_turnErrorMessage",
			"turnErrorRow": "DkAxsq_turnErrorRow",
			"turnErrorTitle": "DkAxsq_turnErrorTitle",
			"userRow": "DkAxsq_userRow",
			"userStack": "DkAxsq_userStack"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/ContextBody.module.css.mjs
		const css$14 = ".Z1IIFW_text{color:var(--dsw-alias-label-secondary);font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.Z1IIFW_fields{border-top:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:2px;margin:8px 0 0;padding-top:8px;display:flex}.Z1IIFW_field{gap:8px;min-width:0;display:flex}.Z1IIFW_fieldKey{min-width:96px;color:var(--dsw-alias-label-caption);flex:none}.Z1IIFW_fieldValue{min-width:0;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;flex:auto;margin:0}.Z1IIFW_files{flex-wrap:wrap;gap:4px 12px;margin:0 0 8px;padding:0;list-style:none;display:flex}.Z1IIFW_file{align-items:baseline;gap:6px;min-width:0;display:flex}.Z1IIFW_filePath{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.Z1IIFW_fileAction{color:var(--dsw-alias-label-caption)}.Z1IIFW_catalogNotice{color:var(--dsw-alias-label-caption);margin:0 0 6px}.Z1IIFW_entries{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.Z1IIFW_entry{gap:8px;min-width:0;display:flex}.Z1IIFW_entryName{color:var(--dsw-alias-label-secondary);flex:none}.Z1IIFW_entryDescription{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.Z1IIFW_sections{flex-direction:column;gap:8px;margin:0;display:flex}.Z1IIFW_section{flex-direction:column;gap:2px;min-width:0;display:flex}.Z1IIFW_sectionName{color:var(--dsw-alias-label-caption)}.Z1IIFW_sectionText{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.Z1IIFW_relaySender{color:var(--dsw-alias-label-caption);overflow-wrap:anywhere;margin:0 0 6px}.Z1IIFW_recalls{flex-direction:column;gap:2px;margin:0 0 8px;padding:0;list-style:none;display:flex}.Z1IIFW_recall{gap:8px;min-width:0;display:flex}.Z1IIFW_recallLabel{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.Z1IIFW_recallCounts{color:var(--dsw-alias-label-caption);flex:none}";
		...
		var ContextBody_module_css_default = {
			"catalogNotice": "Z1IIFW_catalogNotice",
			"entries": "Z1IIFW_entries",
			"entry": "Z1IIFW_entry",
			"entryDescription": "Z1IIFW_entryDescription",
			"entryName": "Z1IIFW_entryName",
			"field": "Z1IIFW_field",
			"fieldKey": "Z1IIFW_fieldKey",
			"fieldValue": "Z1IIFW_fieldValue",
			"fields": "Z1IIFW_fields",
			"file": "Z1IIFW_file",
			"fileAction": "Z1IIFW_fileAction",
			"filePath": "Z1IIFW_filePath",
			"files": "Z1IIFW_files",
			"recall": "Z1IIFW_recall",
			"recallCounts": "Z1IIFW_recallCounts",
			"recallLabel": "Z1IIFW_recallLabel",
			"recalls": "Z1IIFW_recalls",
			"relaySender": "Z1IIFW_relaySender",
			"section": "Z1IIFW_section",
			"sectionName": "Z1IIFW_sectionName",
			"sectionText": "Z1IIFW_sectionText",
			"sections": "Z1IIFW_sections",
			"text": "Z1IIFW_text"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/ContextInjectionRow.module.css.mjs
		const css$13 = ".fxxDJW_root{min-width:0}.fxxDJW_root[data-open]{padding-bottom:4px}.fxxDJW_chevron{color:var(--dsw-alias-label-secondary)}.fxxDJW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.fxxDJW_source{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.fxxDJW_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.fxxDJW_body{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));max-height:141px;margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);font:400 11px/16px var(--ds-font-family-code);border:none;border-radius:8px;padding:10px 16px 12px 12px;overflow:auto}";
		...
		var ContextInjectionRow_module_css_default = {
			"body": "fxxDJW_body",
			"chevron": "fxxDJW_chevron",
			"root": "fxxDJW_root",
			"sep": "fxxDJW_sep",
			"source": "fxxDJW_source",
			"summary": "fxxDJW_summary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/MessageIconActions.module.css.mjs
		const css$12 = ".b2z61q_actions{height:calc(28px + var(--dsh-content-font-delta,0px));align-items:center;gap:8px;display:flex}.b2z61q_timeStart{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-right:12px}.b2z61q_timeEnd{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap}@media (hover:hover){[data-actions-reveal=hover] .b2z61q_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])) .b2z61q_actions{opacity:0;transition:opacity 80ms}[data-actions-reveal=hover]:hover .b2z61q_actions,[data-actions-reveal=hover]:focus-within .b2z61q_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])):hover .b2z61q_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])):focus-within .b2z61q_actions{opacity:1}}.b2z61q_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.b2z61q_action svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px))}.b2z61q_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.b2z61q_action[data-unavailable]{cursor:default;opacity:.4}.b2z61q_action[data-unavailable]:hover{color:var(--dsw-alias-label-tertiary);background:0 0}.b2z61q_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var MessageIconActions_module_css_default = {
			"action": "b2z61q_action",
			"actions": "b2z61q_actions",
			"timeEnd": "b2z61q_timeEnd",
			"timeStart": "b2z61q_timeStart",
			"visuallyHidden": "b2z61q_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/ChatView.module.css.mjs
		const css$11 = "._4ubRgq_root{flex-direction:column;flex:auto;min-height:0;display:flex;position:relative}._4ubRgq_scroll{min-height:0;padding:16px calc(var(--dsh-composer-side-clearance) + 16px);flex:auto;overflow-y:auto;container-type:inline-size}[data-conversation-scroll] ._4ubRgq_root{flex:none;height:auto;min-height:auto}[data-conversation-scroll] ._4ubRgq_scroll{flex:none;min-height:auto;overflow:visible}._4ubRgq_column{max-width:var(--dsh-chat-content-width);flex-direction:column;width:100%;margin:0 auto;display:flex}._4ubRgq_column>:not([hidden]):not(._4ubRgq_flowItem:empty)~:not([hidden]):not(._4ubRgq_flowItem:empty){margin-top:var(--dsh-chat-flow-gap,16px)}._4ubRgq_flowItem{min-width:0}._4ubRgq_flowItem[data-turn-process-answer]{--dsh-chat-flow-gap:8px}._4ubRgq_flowItem:empty{display:none}._4ubRgq_callRow{border-radius:6px}._4ubRgq_turnStatus{height:calc(26px + var(--dsh-content-font-delta,0px));font:var(--dsw-font-s-strong-14);font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));white-space:nowrap;background:linear-gradient(90deg, var(--dsw-static-deepseek-500) 0%, var(--dsw-static-deepseek-500) 40%, var(--dsw-static-deepseek-200) 50%, var(--dsw-static-deepseek-500) 60%, var(--dsw-static-deepseek-500) 100%);color:#0000;-webkit-text-fill-color:transparent;background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;flex:none;align-self:flex-start;align-items:center;animation:1.8s linear infinite _4ubRgq_dsh-turn-status-shimmer;display:inline-flex}._4ubRgq_turnStatusClock{font:var(--dsw-font-xs-13);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-caption);-webkit-text-fill-color:var(--dsw-alias-label-caption);margin-left:8px;font-weight:400}@keyframes _4ubRgq_dsh-turn-status-shimmer{to{background-position:0 0}}@media (prefers-reduced-motion:reduce){._4ubRgq_turnStatus{background-position:0 0;background-size:100% 100%;animation:none}}._4ubRgq_hint{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}._4ubRgq_openError{color:var(--dsw-alias-state-error-primary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}._4ubRgq_older{justify-content:center;display:flex}._4ubRgq_older button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover-solid);cursor:pointer;border:none;border-radius:14px;padding:4px 12px;font-size:12px}._4ubRgq_older button:disabled{cursor:default;opacity:.6}._4ubRgq_toBottomSlot{z-index:8;height:0;padding-right:max(0px, calc((100% - var(--dsh-chat-content-width)) / 2));pointer-events:none;justify-content:flex-end;display:flex;position:sticky;bottom:16px}[data-conversation-scroll] ._4ubRgq_toBottomSlot{bottom:calc(var(--dsh-composer-height,152px) + 16px)}._4ubRgq_toBottom{--dsw-elevation-stroke-color:var(--dsw-alias-border-l3);corner-shape:round;width:34px;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-floating-fill);box-shadow:var(--dsw-elevation-panel);cursor:pointer;pointer-events:auto;border:0;border-radius:100px;justify-content:center;align-items:center;margin-top:-34px;padding:0;display:flex}._4ubRgq_toBottom:hover{background:var(--dsw-alias-button-floating-hover)}._4ubRgq_modalAction{min-width:72px}";
		...
		var ChatView_module_css_default = {
			"callRow": "_4ubRgq_callRow",
			"column": "_4ubRgq_column",
			"dsh-turn-status-shimmer": "_4ubRgq_dsh-turn-status-shimmer",
			"flowItem": "_4ubRgq_flowItem",
			"hint": "_4ubRgq_hint",
			"modalAction": "_4ubRgq_modalAction",
			"older": "_4ubRgq_older",
			"openError": "_4ubRgq_openError",
			"root": "_4ubRgq_root",
			"scroll": "_4ubRgq_scroll",
			"toBottom": "_4ubRgq_toBottom",
			"toBottomSlot": "_4ubRgq_toBottomSlot",
			"turnStatus": "_4ubRgq_turnStatus",
			"turnStatusClock": "_4ubRgq_turnStatusClock"
		};
		//#endregion
		...
		const ChatNodeSeat = (0, react.memo)(function ChatNodeSeat({ nodeKey, useChatNode, useChatNodeProcess, historyIncomplete, compactTranscript, cwd, openFile, openSkill, inspectCall, forkAt, loadImage, renderMessageImages, fileMentions, useStore, actions, renderSlot, t }) {
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/TurnNavigator.module.css.mjs
		const css$10 = "._1uuiNa_slot{z-index:7;pointer-events:none;height:0;position:sticky;top:0}._1uuiNa_frame{--turn-rail-band:calc(var(--dsh-conversation-viewport-height,100dvh) - var(--dsh-composer-height,152px));--turn-preview-height:100px;top:calc(var(--turn-rail-band) / 2);right:calc(12px - (var(--dsh-composer-side-clearance) + 16px));width:28px;height:min(var(--turn-natural-height), max(0px, calc(var(--turn-rail-band) - 64px)), 420px);cursor:pointer;pointer-events:auto;transition:height .22s cubic-bezier(.2,.8,.2,1);position:absolute;transform:translateY(-50%)}._1uuiNa_scroller{overscroll-behavior:contain;scrollbar-width:none;position:absolute;inset:0;overflow-y:auto}._1uuiNa_scroller::-webkit-scrollbar{display:none}._1uuiNa_fadeTop{mask-image:linear-gradient(#0000 0,#000 24px 100%)}._1uuiNa_fadeBottom{mask-image:linear-gradient(#000 0 calc(100% - 24px),#0000 100%)}._1uuiNa_fadeTop._1uuiNa_fadeBottom{mask-image:linear-gradient(#0000 0,#000 24px calc(100% - 24px),#0000 100%)}._1uuiNa_marks{height:var(--turn-natural-height);position:relative}._1uuiNa_markPosition{top:calc(var(--turn-natural-position) + var(--turn-rail-inset));height:10px;transition:top .22s cubic-bezier(.2,.8,.2,1);animation:.15s ease-out _1uuiNa_dsh-turn-mark-enter;position:absolute;left:0;right:0;transform:translateY(-50%)}._1uuiNa_mark{cursor:pointer;pointer-events:none;background:0 0;border:0;border-radius:8px;width:20px;padding:0;position:absolute;inset:0 0 0 auto}._1uuiNa_mark:before{background:var(--dsw-alias-border-l4);content:\"\";border-radius:2px;width:12px;height:2px;transition:width .14s,background-color .14s;position:absolute;top:50%;right:0;transform:translateY(-50%)}._1uuiNa_markUnloaded:before{opacity:.6;width:8px}._1uuiNa_markPreview:before{background:var(--dsw-alias-label-tertiary);width:18px}._1uuiNa_markBusy:before{animation:1s ease-in-out infinite _1uuiNa_dsh-turn-mark-busy}._1uuiNa_markActive:before{background:var(--dsw-alias-label-primary);width:20px}._1uuiNa_mark:focus-visible:before{background:var(--dsw-alias-state-business-primary);width:20px}._1uuiNa_mark:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._1uuiNa_preview{top:clamp(0px, calc(var(--turn-natural-position) + var(--turn-rail-inset) - var(--turn-scroll-top,0px) - var(--turn-preview-height) / 2), calc(100% - var(--turn-preview-height)));box-sizing:border-box;width:min(300px,100cqw - 120px);max-height:var(--turn-preview-height);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-elevation-panel);pointer-events:none;border:0;border-radius:10px;padding:10px 12px;transition:top .14s cubic-bezier(.2,.8,.2,1);animation:.12s ease-out _1uuiNa_dsh-turn-preview-enter;position:absolute;right:calc(100% + 10px);overflow:hidden}._1uuiNa_previewPrompt,._1uuiNa_previewResponse{-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._1uuiNa_previewPrompt{font:var(--dsw-font-xs-strong-13);-webkit-line-clamp:1}._1uuiNa_previewResponse{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xxs-12);-webkit-line-clamp:3;margin-top:4px}@keyframes _1uuiNa_dsh-turn-mark-enter{0%{opacity:0}to{opacity:1}}@keyframes _1uuiNa_dsh-turn-preview-enter{0%{opacity:0;transform:translate(4px)}to{opacity:1;transform:translate(0)}}@keyframes _1uuiNa_dsh-turn-mark-busy{0%,to{opacity:1}50%{opacity:.35}}@container (width<=900px){._1uuiNa_slot{display:none}}@media (prefers-reduced-motion:reduce){._1uuiNa_frame,._1uuiNa_scroller,._1uuiNa_markPosition,._1uuiNa_mark:before,._1uuiNa_markBusy:before,._1uuiNa_preview{scroll-behavior:auto;transition:none;animation:none}}";
		...
		var TurnNavigator_module_css_default = {
			"dsh-turn-mark-busy": "_1uuiNa_dsh-turn-mark-busy",
			"dsh-turn-mark-enter": "_1uuiNa_dsh-turn-mark-enter",
			"dsh-turn-preview-enter": "_1uuiNa_dsh-turn-preview-enter",
			"fadeBottom": "_1uuiNa_fadeBottom",
			"fadeTop": "_1uuiNa_fadeTop",
			"frame": "_1uuiNa_frame",
			"mark": "_1uuiNa_mark",
			"markActive": "_1uuiNa_markActive",
			"markBusy": "_1uuiNa_markBusy",
			"markPosition": "_1uuiNa_markPosition",
			"markPreview": "_1uuiNa_markPreview",
			"markUnloaded": "_1uuiNa_markUnloaded",
			"marks": "_1uuiNa_marks",
			"preview": "_1uuiNa_preview",
			"previewPrompt": "_1uuiNa_previewPrompt",
			"previewResponse": "_1uuiNa_previewResponse",
			"scroller": "_1uuiNa_scroller",
			"slot": "_1uuiNa_slot"
		};
		//#endregion
		...
		*/
		function ChatView({ useSession, useChat, useChatNode, useChatNodeProcess, useSessions, useStore, actions, renderSlot, sessionId, openFile, openSkill, loadOlder, loadThrough, loadImage, openView, chatScroll, forkAt, fileMentions, useTranscriptView, useProjection, t }) {
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/accessibility.module.css.mjs
		const css$9 = ".nQ4W-a_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var accessibility_module_css_default = { "visuallyHidden": "nQ4W-a_visuallyHidden" };
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/ReasoningRow.module.css.mjs
		const css$8 = ".F7IxqG_root{flex-direction:column;display:flex}.F7IxqG_root:not([data-expanded]){contain:size layout;height:calc(24px + var(--dsh-content-font-delta,0px))}.F7IxqG_row{position:relative;overflow:hidden}.F7IxqG_root[data-expanded] [data-open] [data-disclosure-row]{z-index:1;background:var(--dsw-alias-bg-base);position:sticky;top:0}.F7IxqG_root[data-state=running] .F7IxqG_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite F7IxqG_dsh-reasoning-row-sweep;position:absolute;left:0}@keyframes F7IxqG_dsh-reasoning-row-sweep{0%{left:-300px}90%,to{left:100%}}.F7IxqG_leading{flex-shrink:0}.F7IxqG_chevron{color:var(--dsw-alias-label-secondary)}.F7IxqG_title{font-weight:400}.F7IxqG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.F7IxqG_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:nowrap;flex:auto;overflow:hidden}.F7IxqG_summaryText{text-overflow:ellipsis;display:block;overflow:hidden}.F7IxqG_summary[data-follow-end]{justify-content:flex-end;display:flex}.F7IxqG_summary[data-follow-end] .F7IxqG_summaryText{text-align:start;text-overflow:clip;flex:none;width:max-content;min-width:100%;overflow:visible}.F7IxqG_thinkBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:pre-wrap;word-break:break-word}@media (prefers-reduced-motion:reduce){.F7IxqG_root[data-state=running] .F7IxqG_row:after{animation:none}}";
		...
		var ReasoningRow_module_css_default = {
			"chevron": "F7IxqG_chevron",
			"dsh-reasoning-row-sweep": "F7IxqG_dsh-reasoning-row-sweep",
			"leading": "F7IxqG_leading",
			"root": "F7IxqG_root",
			"row": "F7IxqG_row",
			"separator": "F7IxqG_separator",
			"summary": "F7IxqG_summary",
			"summaryText": "F7IxqG_summaryText",
			"thinkBody": "F7IxqG_thinkBody",
			"title": "F7IxqG_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/AssistantMarkdown.module.css.mjs
		const css$7 = ".Wls6aa_root{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.Wls6aa_body{flex-direction:column;gap:16px;display:flex}.Wls6aa_body .md-table-wide{--dsh-table-spare:max(0px, calc((100cqw - var(--dsh-chat-content-width)) / 2));--dsh-table-lead:calc(var(--dsh-table-spare) + min(var(--dsh-chat-content-width), 100cqw) - 100%);box-sizing:border-box;width:calc(100% + var(--dsh-table-lead) + var(--dsh-table-spare));max-width:none;margin-left:calc(-1 * var(--dsh-table-lead));padding-left:var(--dsh-table-lead)}.Wls6aa_body>[data-turn-process-inline][hidden]{margin-bottom:-16px}.Wls6aa_stopped{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);border-radius:6px;align-self:flex-start;padding:0 6px;font-size:11px;line-height:18px}.Wls6aa_actions{margin-top:16px;margin-left:-6px}";
		...
		var AssistantMarkdown_module_css_default = {
			"actions": "Wls6aa_actions",
			"body": "Wls6aa_body",
			"root": "Wls6aa_root",
			"stopped": "Wls6aa_stopped"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/GenericCommandCard.module.css.mjs
		const css$6 = ".xAzvRG_root{flex-direction:column;display:flex}.xAzvRG_row{position:relative;overflow:hidden}.xAzvRG_root[data-state=running] .xAzvRG_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite xAzvRG_dsh-command-row-sweep;position:absolute;left:0}@keyframes xAzvRG_dsh-command-row-sweep{0%{left:-300px}90%,to{left:100%}}.xAzvRG_leading{flex-shrink:0}.xAzvRG_chevron{color:var(--dsw-alias-label-secondary)}.xAzvRG_title{font-weight:400}.xAzvRG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.xAzvRG_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.xAzvRG_summary[data-error],.xAzvRG_body[data-error]{color:var(--dsw-alias-state-error-primary)}.xAzvRG_body{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);max-height:260px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;border-radius:12px;margin:4px 0 4px 4px;padding:12px 16px;overflow:auto}@media (prefers-reduced-motion:reduce){.xAzvRG_root[data-state=running] .xAzvRG_row:after{animation:none}}";
		...
		var GenericCommandCard_module_css_default = {
			"body": "xAzvRG_body",
			"chevron": "xAzvRG_chevron",
			"dsh-command-row-sweep": "xAzvRG_dsh-command-row-sweep",
			"leading": "xAzvRG_leading",
			"root": "xAzvRG_root",
			"row": "xAzvRG_row",
			"separator": "xAzvRG_separator",
			"summary": "xAzvRG_summary",
			"title": "xAzvRG_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/TurnProcessNodeView.module.css.mjs
		const css$5 = ".zinz7W_root{box-sizing:border-box;border:none;border-bottom:.5px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:33px;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;background:0 0;align-items:center;padding:0 0 8px;display:flex}.zinz7W_root:not([data-open]){margin-bottom:8px}.zinz7W_chevron{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:6px;transition:transform .1s;transform:rotate(-90deg)}.zinz7W_root[data-open] .zinz7W_chevron{transform:rotate(0)}.zinz7W_label{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:24px;overflow:hidden}@media (prefers-reduced-motion:reduce){.zinz7W_chevron{transition:none}}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/TurnUsagePanel.module.css.mjs
		const css$4 = ".Qy-Y4a_root{min-width:0;display:inline-flex}.Qy-Y4a_root+.Qy-Y4a_root{margin-left:-6px}.Qy-Y4a_trigger{min-width:0;height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);font-variant-numeric:tabular-nums;line-height:calc(24px + var(--dsh-content-font-delta,0px));white-space:nowrap;cursor:pointer;background:0 0;border:none;border-radius:28px;align-items:center;gap:4px;padding:6px 8px;display:inline-flex}.Qy-Y4a_label{text-overflow:ellipsis;min-width:0;overflow:hidden}.Qy-Y4a_trigger svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px));flex:none}.Qy-Y4a_trigger:hover,.Qy-Y4a_trigger[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}@media (width<=480px){.Qy-Y4a_trigger{width:calc(28px + var(--dsh-content-font-delta,0px));justify-content:center;padding:6px}.Qy-Y4a_trigger .Qy-Y4a_label{display:none}.Qy-Y4a_root+.Qy-Y4a_root{margin-left:0}}";
		...
		var TurnUsagePanel_module_css_default = {
			"label": "Qy-Y4a_label",
			"root": "Qy-Y4a_root",
			"trigger": "Qy-Y4a_trigger"
		};
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/stat-dialog.module.css.mjs
		const css$3 = ".m0BExG_panel{z-index:1100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(300px,100vw - 24px);max-width:min(440px,100vw - 24px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-secondary);cursor:default;border:0;border-radius:12px;padding:16px;font-size:12px;line-height:18px;position:fixed}.m0BExG_title{color:var(--dsw-alias-label-primary);justify-content:space-between;gap:16px;margin-bottom:8px;font-weight:500;display:flex}.m0BExG_titleRule{border-top:.5px solid var(--dsw-alias-border-l2);margin-bottom:10px}.m0BExG_titleValue{font-variant-numeric:tabular-nums}.m0BExG_titleLabel{align-items:center;gap:6px;min-width:0;display:inline-flex}.m0BExG_titleLabel svg{flex:none;width:14px;height:14px}.m0BExG_details{color:var(--dsw-alias-label-tertiary);grid-template-columns:minmax(76px,auto) minmax(0,1fr);gap:6px 16px;margin:0;display:grid}.m0BExG_details dt,.m0BExG_details dd{min-width:0;margin:0}.m0BExG_details dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right}.m0BExG_details .m0BExG_route{overflow-wrap:anywhere}.m0BExG_reasoning{color:var(--dsw-alias-label-tertiary);white-space:nowrap}";
		...
		var stat_dialog_module_css_default = {
			"details": "m0BExG_details",
			"panel": "m0BExG_panel",
			"reasoning": "m0BExG_reasoning",
			"route": "m0BExG_route",
			"title": "m0BExG_title",
			"titleLabel": "m0BExG_titleLabel",
			"titleRule": "m0BExG_titleRule",
			"titleValue": "m0BExG_titleValue"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/TurnTailNodeView.module.css.mjs
		const css$2 = ".CZsh9a_root{flex-direction:column;gap:16px;display:flex}.CZsh9a_actions{margin-top:4px;margin-left:-6px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/chat/StatsPills.module.css.mjs
		const css$1 = ".E3EThq_root{max-width:var(--dsh-chat-content-width);box-sizing:border-box;width:100%;padding:4px calc(var(--dsh-composer-side-clearance) + 16px) 0px;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));justify-content:center;gap:12px;margin:0 auto;display:flex}.E3EThq_anchor{min-width:0;display:inline-flex}.E3EThq_pill{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-tertiary);font:inherit;font-variant-numeric:tabular-nums;line-height:inherit;white-space:nowrap;background:0 0;border:none;border-radius:24px;align-items:center;gap:6px;padding:1px 8px;display:inline-flex}.E3EThq_pill svg{flex:none;width:14px;height:14px}button.E3EThq_pill{cursor:pointer}button.E3EThq_pill:hover,button.E3EThq_pill[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.E3EThq_label{text-overflow:ellipsis;min-width:0;overflow:hidden}.E3EThq_sep{color:var(--dsw-alias-separator-primary);margin:0 6px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-chat/src/client/settings/TranscriptViewRow.module.css.mjs
		const css = "._6YKn_W_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._6YKn_W_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._6YKn_W_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._6YKn_W_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._6YKn_W_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._6YKn_W_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}._6YKn_W_chevron{flex:none}";
		...
		var TranscriptViewRow_module_css_default = {
			"chevron": "_6YKn_W_chevron",
			"desc": "_6YKn_W_desc",
			"row": "_6YKn_W_row",
			"rowText": "_6YKn_W_rowText",
			"selector": "_6YKn_W_selector",
			"title": "_6YKn_W_title"
		};
		//#endregion
