...
function outlineEntry(value) {
    ...
    if (typeof entry.turn !== 'number' || !Number.isSafeInteger(entry.turn) || entry.turn < 0)
        return undefined;
    if (typeof entry.seq !== 'number' || !Number.isSafeInteger(entry.seq) || entry.seq < 0 || Object.is(entry.seq, -0))
        return undefined;
    return {
        turn: entry.turn,
 ...
 */
export function mergeTurnRailItems(loaded, outline) {
...
//# sourceMappingURL=turn-rail-items.js.map