window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-theme/src/client/AppearanceRow.module.css.mjs
		const css$1 = ".JuOopq_group{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.JuOopq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.JuOopq_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}.JuOopq_themeCube{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}.JuOopq_themeCube:hover:not(.JuOopq_selected){background:var(--dsw-alias-interactive-bg-hover)}.JuOopq_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "JuOopq_cubeRow",
			"group": "JuOopq_group",
			"selected": "JuOopq_selected",
			"themeCube": "JuOopq_themeCube",
			"title": "JuOopq_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-theme/src/client/FontSizeRow.module.css.mjs
		const css = "._3mXl_a_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._3mXl_a_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._3mXl_a_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._3mXl_a_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._3mXl_a_control{align-items:center;gap:8px;display:inline-flex}._3mXl_a_stepper{background:var(--dsw-alias-bg-module-platform);border-radius:18px;justify-content:center;align-items:center;min-width:72px;height:36px;display:inline-flex;position:relative}._3mXl_a_value{text-align:center;font-variant-numeric:tabular-nums;min-width:18px;color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}._3mXl_a_unit{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}._3mXl_a_arrows{opacity:0;flex-direction:column;gap:2px;display:flex;position:absolute;right:8px}._3mXl_a_stepper:hover ._3mXl_a_arrows,._3mXl_a_stepper:focus-within ._3mXl_a_arrows{opacity:1}._3mXl_a_arrow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 75%, transparent);width:17px;height:12px;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:3px;justify-content:center;align-items:center;padding:0;display:inline-flex}._3mXl_a_arrow:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}._3mXl_a_arrow:disabled{color:var(--dsw-alias-label-caption);cursor:default}";
		...
		var FontSizeRow_module_css_default = {
			"arrow": "_3mXl_a_arrow",
			"arrows": "_3mXl_a_arrows",
			"control": "_3mXl_a_control",
			"desc": "_3mXl_a_desc",
			"row": "_3mXl_a_row",
			"rowText": "_3mXl_a_rowText",
			"stepper": "_3mXl_a_stepper",
			"title": "_3mXl_a_title",
			"unit": "_3mXl_a_unit",
			"value": "_3mXl_a_value"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-inline-css:/Users/deepak/deepseek-harness/packages/client/ui-theme/src/styles/base.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/Users/deepak/deepseek-harness/packages/client/ui-theme/src/styles/corner-shape.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/Users/deepak/deepseek-harness/packages/client/ui-theme/src/styles/shiki.css.mjs
