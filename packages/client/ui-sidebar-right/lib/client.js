window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-sidebar-right/src/client/tabs/guide/GuideBody.module.css.mjs
		const css$2 = ".UOyOtq_guide{box-sizing:border-box;flex-direction:column;justify-content:center;align-items:center;gap:14px;min-height:100%;padding:0 24px;display:flex}.UOyOtq_guide:after{content:\"\";flex:0 10%}.UOyOtq_hero{color:var(--dsw-static-neutral-200);margin-bottom:16px;display:flex}body[data-ds-dark-theme] .UOyOtq_hero{color:var(--dsw-static-neutral-700)}.UOyOtq_entry{box-sizing:border-box;width:380px;max-width:100%;min-height:56px;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;background:var(--dsw-alias-bg-layer-1);border:.5px solid var(--dsw-alias-border-l4);cursor:pointer;border-radius:24px;align-items:center;gap:14px;padding:14px 20px;display:flex}.UOyOtq_entry:hover{background:var(--dsw-alias-interactive-bg-hover)}.UOyOtq_entryIcon{width:26px;height:26px;color:var(--dsw-alias-label-secondary);flex:none;justify-content:center;align-items:center;display:flex}.UOyOtq_placeholderInk{color:var(--dsw-alias-label-tertiary)}.UOyOtq_entryText{flex-direction:column;gap:3px;min-width:0;display:flex}.UOyOtq_entryTitle{white-space:nowrap;text-overflow:ellipsis;font-size:15px;line-height:1.4;overflow:hidden}.UOyOtq_entryDescription{color:var(--dsw-alias-label-caption);white-space:nowrap;text-overflow:ellipsis;font-size:13px;line-height:1.4;overflow:hidden}.UOyOtq_titleIcon{color:var(--dsw-alias-label-tertiary);flex:none}.UOyOtq_entryCell{width:380px;max-width:100%}";
		...
		var GuideBody_module_css_default = {
			"entry": "UOyOtq_entry",
			"entryCell": "UOyOtq_entryCell",
			"entryDescription": "UOyOtq_entryDescription",
			"entryIcon": "UOyOtq_entryIcon",
			"entryText": "UOyOtq_entryText",
			"entryTitle": "UOyOtq_entryTitle",
			"guide": "UOyOtq_guide",
			"hero": "UOyOtq_hero",
			"placeholderInk": "UOyOtq_placeholderInk",
			"titleIcon": "UOyOtq_titleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-sidebar-right/src/client/shell/ExpandButton.module.css.mjs
		const css$1 = ".IXo1Kq_button{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:28px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex}.IXo1Kq_button svg{width:15px;height:15px}.IXo1Kq_button:hover{background:var(--dsw-alias-interactive-bg-hover)}.IXo1Kq_icon{transform:scaleX(-1)}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-sidebar-right/src/client/shell/SidebarRight.module.css.mjs
		const css = ".zFZfwG_panel{z-index:10;background:var(--dsw-alias-bg-base);border-left:.5px solid var(--dsw-alias-border-l4);visibility:hidden;min-width:0;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);flex-direction:column;display:flex;position:absolute;top:0;bottom:0;right:0;transform:translate(100%)}.zFZfwG_panel[data-sidebar-right-open]{visibility:visible;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out);transform:none}.zFZfwG_panel[data-sidebar-right-panel=fullscreen]{z-index:40;border:none;position:fixed;inset:0}@media (prefers-reduced-motion:reduce){.zFZfwG_panel,.zFZfwG_panel[data-sidebar-right-open]{transition:none}}.zFZfwG_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:28px;flex:none;justify-content:center;align-items:center;padding:6px;line-height:1;display:inline-flex}.zFZfwG_iconButton svg{width:15px;height:15px}.zFZfwG_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.zFZfwG_collapseGlyph{transform:scaleX(-1)}.zFZfwG_panelBody{flex:auto;min-height:0;display:flex}.zFZfwG_unavailable{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);margin:0;padding:12px}.zFZfwG_floatHost{z-index:60;pointer-events:none;position:fixed;inset:0}";
		...
		var SidebarRight_module_css_default = {
			"collapseGlyph": "zFZfwG_collapseGlyph",
			"floatHost": "zFZfwG_floatHost",
			"iconButton": "zFZfwG_iconButton",
			"panel": "zFZfwG_panel",
			"panelBody": "zFZfwG_panelBody",
			"unavailable": "zFZfwG_unavailable"
		};
		//#endregion
