window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-subagent/src/client/SubagentHeaderLineage.module.css.mjs
		const css$1 = ".PfEQNW_root{align-items:center;gap:10px;min-width:0;display:inline-flex;position:relative}.PfEQNW_switcherRoot{min-width:0;margin-left:6px}.PfEQNW_trigger,.PfEQNW_switcherTrigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.PfEQNW_trigger{gap:4px}.PfEQNW_switcherTrigger{min-width:0;max-width:244px;color:var(--dsw-alias-label-primary);gap:4px;font-weight:500}.PfEQNW_ancestorSwitcherTrigger{color:var(--dsw-alias-label-tertiary);font-weight:400}.PfEQNW_switcherTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.PfEQNW_switcherTrigger svg{flex:none}.PfEQNW_separator{color:var(--dsw-alias-label-caption);font-size:14px;line-height:20px}.PfEQNW_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.PfEQNW_trigger:hover,.PfEQNW_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.PfEQNW_switcherTrigger:hover,.PfEQNW_switcherTrigger:focus-visible{color:var(--dsw-alias-label-primary)}.PfEQNW_ancestorSwitcherTrigger:hover,.PfEQNW_ancestorSwitcherTrigger:focus-visible{color:var(--dsw-alias-label-tertiary)}.PfEQNW_trigger svg,.PfEQNW_switcherTrigger svg{transition:transform .12s}.PfEQNW_triggerOpen{transform:rotate(180deg)}.PfEQNW_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border-radius:20px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:auto}.PfEQNW_node{min-width:0;position:relative}.PfEQNW_menu>.PfEQNW_node{margin-left:-3px}.PfEQNW_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.PfEQNW_row:hover>.PfEQNW_clickarea,.PfEQNW_row:focus-visible>.PfEQNW_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.PfEQNW_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.PfEQNW_row>[data-state],.PfEQNW_clickarea>[data-state]{margin-top:4px}.PfEQNW_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.PfEQNW_disabled:hover{background:0 0}.PfEQNW_loadingRow{cursor:default}.PfEQNW_disclosure,.PfEQNW_disclosureSpace{flex:none;width:14px;height:18px}.PfEQNW_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.PfEQNW_disclosure:hover{color:var(--dsw-alias-label-primary)}.PfEQNW_disclosureOpen{transform:rotate(90deg)}.PfEQNW_content{flex-direction:column;flex:1;min-width:0;display:flex}.PfEQNW_label,.PfEQNW_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.PfEQNW_label{color:inherit;font-weight:400}.PfEQNW_currentLabel{font-weight:600}.PfEQNW_summary,.PfEQNW_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.PfEQNW_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.PfEQNW_metricToken{grid-row:1;line-height:18px}.PfEQNW_metricDuration{grid-row:2}.PfEQNW_children{margin-left:18px;padding-left:4px;position:relative}.PfEQNW_children:before,.PfEQNW_children>.PfEQNW_node:before{content:\"\";border-left:.5px solid var(--dsw-alias-border-l2);position:absolute;left:0}.PfEQNW_children:before{height:26px;top:-26px}.PfEQNW_children[aria-busy=true]:before{content:none}.PfEQNW_children>.PfEQNW_node:before{top:0;bottom:0;left:-4px}.PfEQNW_children>.PfEQNW_node:last-child:before{height:17px;bottom:auto}.PfEQNW_children>.PfEQNW_node>.PfEQNW_row:before{content:\"\";border-top:.5px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.PfEQNW_notice,.PfEQNW_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.PfEQNW_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.PfEQNW_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.PfEQNW_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentHeaderLineage_module_css_default = {
			"activitySlot": "PfEQNW_activitySlot",
			"ancestorSwitcherTrigger": "PfEQNW_ancestorSwitcherTrigger",
			"children": "PfEQNW_children",
			"clickarea": "PfEQNW_clickarea",
			"content": "PfEQNW_content",
			"currentLabel": "PfEQNW_currentLabel",
			"disabled": "PfEQNW_disabled",
			"disclosure": "PfEQNW_disclosure",
			"disclosureOpen": "PfEQNW_disclosureOpen",
			"disclosureSpace": "PfEQNW_disclosureSpace",
			"error": "PfEQNW_error",
			"label": "PfEQNW_label",
			"loadingRow": "PfEQNW_loadingRow",
			"menu": "PfEQNW_menu",
			"metricDuration": "PfEQNW_metricDuration",
			"metricToken": "PfEQNW_metricToken",
			"metrics": "PfEQNW_metrics",
			"node": "PfEQNW_node",
			"notice": "PfEQNW_notice",
			"refresh": "PfEQNW_refresh",
			"root": "PfEQNW_root",
			"row": "PfEQNW_row",
			"separator": "PfEQNW_separator",
			"summary": "PfEQNW_summary",
			"switcherRoot": "PfEQNW_switcherRoot",
			"switcherTitle": "PfEQNW_switcherTitle",
			"switcherTrigger": "PfEQNW_switcherTrigger",
			"trigger": "PfEQNW_trigger",
			"triggerOpen": "PfEQNW_triggerOpen"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-subagent/src/client/SubagentReadOnlyComposer.module.css.mjs
		const css = ".sEbY4W_frame{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.sEbY4W_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "sEbY4W_frame" };
		//#endregion
