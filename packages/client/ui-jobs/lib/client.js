window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = ".ILf3Ca_root{position:relative}.ILf3Ca_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.ILf3Ca_trigger:hover,.ILf3Ca_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.ILf3Ca_trigger svg{transition:transform .12s}.ILf3Ca_triggerOpen{transform:rotate(180deg)}.ILf3Ca_triggerDot{flex:none}.ILf3Ca_count{margin:0 5px}.ILf3Ca_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.ILf3Ca_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.ILf3Ca_rowSettled{color:var(--dsw-alias-label-tertiary)}.ILf3Ca_rowDot{flex:none}.ILf3Ca_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.ILf3Ca_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.ILf3Ca_status,.ILf3Ca_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.ILf3Ca_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.ILf3Ca_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"count": "ILf3Ca_count",
			"duration": "ILf3Ca_duration",
			"kind": "ILf3Ca_kind",
			"label": "ILf3Ca_label",
			"menu": "ILf3Ca_menu",
			"root": "ILf3Ca_root",
			"row": "ILf3Ca_row",
			"rowDot": "ILf3Ca_rowDot",
			"rowSettled": "ILf3Ca_rowSettled",
			"status": "ILf3Ca_status",
			"trigger": "ILf3Ca_trigger",
			"triggerDot": "ILf3Ca_triggerDot",
			"triggerOpen": "ILf3Ca_triggerOpen"
		};
		//#endregion
