window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-sidebar-files/src/client/FilesBody.module.css.mjs
		const css = ".hdgHLa_root{height:100%;min-height:0;color:var(--dsw-alias-label-primary);font-size:var(--dsh-content-font-size-secondary,13px);flex-direction:column;flex:auto;line-height:1.5;display:flex}.hdgHLa_header{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l3);flex:none;align-items:center;gap:4px;height:38px;padding:0 6px 0 16px;display:flex}.hdgHLa_path{white-space:nowrap;flex:auto;justify-content:flex-end;min-width:0;margin-right:12px;font-size:12px;display:flex;overflow:hidden}.hdgHLa_path[data-files-path-clipped]{mask-image:linear-gradient(90deg,#0000,#000 28px)}.hdgHLa_pathText{flex:none;margin-right:auto}.hdgHLa_pathDirectory{color:var(--dsw-alias-label-tertiary)}.hdgHLa_pathName{color:var(--dsw-alias-label-primary)}.hdgHLa_body{scrollbar-gutter:stable;flex:auto;min-height:0;margin-right:2px;padding:8px 0 8px 8px;overflow:auto}.hdgHLa_body::-webkit-scrollbar-track{margin:2px}.hdgHLa_level{margin:0;padding:0;list-style:none}.hdgHLa_level .hdgHLa_level{padding-left:18px}.hdgHLa_item{margin:0;padding:0}.hdgHLa_row{width:100%;min-width:0;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:10px;align-items:center;gap:6px;padding:5px 10px;display:flex}.hdgHLa_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.hdgHLa_icon{color:var(--dsw-alias-label-tertiary);flex:none}.hdgHLa_fileIcon{flex:none}.hdgHLa_name{white-space:nowrap;text-overflow:ellipsis;min-width:0;overflow:hidden}.hdgHLa_other{color:var(--dsw-alias-label-tertiary);cursor:default}.hdgHLa_other:hover{background:0 0}.hdgHLa_note{color:var(--dsw-alias-label-tertiary);margin:0;padding:3px 10px;font-size:12px}.hdgHLa_status{flex-direction:column;padding:12px 10px;display:flex}.hdgHLa_statusLine{color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);margin:0;line-height:1.6}.hdgHLa_tool{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:28px;flex:none;justify-content:center;align-items:center;padding:6px;line-height:1;display:inline-flex}.hdgHLa_tool svg{width:15px;height:15px}.hdgHLa_tool:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.hdgHLa_titleIcon{flex:none}";
		...
		var FilesBody_module_css_default = {
			"body": "hdgHLa_body",
			"fileIcon": "hdgHLa_fileIcon",
			"header": "hdgHLa_header",
			"icon": "hdgHLa_icon",
			"item": "hdgHLa_item",
			"level": "hdgHLa_level",
			"name": "hdgHLa_name",
			...
			"other": "hdgHLa_other",
			"path": "hdgHLa_path",
			"pathDirectory": "hdgHLa_pathDirectory",
			"pathName": "hdgHLa_pathName",
			"pathText": "hdgHLa_pathText",
			"root": "hdgHLa_root",
			"row": "hdgHLa_row",
			"status": "hdgHLa_status",
			"statusLine": "hdgHLa_statusLine",
			"titleIcon": "hdgHLa_titleIcon",
			"tool": "hdgHLa_tool"
		};
		//#endregion
