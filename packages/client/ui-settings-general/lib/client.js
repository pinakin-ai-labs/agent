window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$3 = "._9bHOuW_triggerRow{flex:none;align-items:center;gap:8px;width:calc(100% + 4px);margin:4px -2px;display:flex}._9bHOuW_triggerRow._9bHOuW_railRow{width:36px;margin:8px 0 10px}._9bHOuW_trigger{box-sizing:border-box;cursor:pointer;width:auto;min-width:0;height:42px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:1;align-items:center;gap:8px;margin:0;padding:0 10px 0 8px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}._9bHOuW_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}._9bHOuW_trigger._9bHOuW_rail{corner-shape:round;border-radius:50%;flex:none;justify-content:center;gap:0;width:36px;height:36px;margin:0;padding:0}._9bHOuW_triggerLabel{white-space:nowrap;overflow:hidden}._9bHOuW_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}._9bHOuW_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}._9bHOuW_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:32px;display:flex;position:relative;overflow:hidden}._9bHOuW_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}._9bHOuW_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}._9bHOuW_navList{flex-direction:column;gap:4px;display:flex}._9bHOuW_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}._9bHOuW_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}._9bHOuW_navCell._9bHOuW_active{background:var(--dsw-specific-sidebar-nav-item-active)}._9bHOuW_navIcon{flex:none}._9bHOuW_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}._9bHOuW_content{flex-direction:column;flex:1;min-width:0;display:flex}._9bHOuW_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}._9bHOuW_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}._9bHOuW_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}._9bHOuW_close:hover{background:var(--dsw-alias-interactive-bg-hover)}._9bHOuW_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}._9bHOuW_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"actions": "_9bHOuW_actions",
			"active": "_9bHOuW_active",
			"close": "_9bHOuW_close",
			"content": "_9bHOuW_content",
			"header": "_9bHOuW_header",
			"hiddenLabel": "_9bHOuW_hiddenLabel",
			"mask": "_9bHOuW_mask",
			"nav": "_9bHOuW_nav",
			"navCell": "_9bHOuW_navCell",
			"navIcon": "_9bHOuW_navIcon",
			"navLabel": "_9bHOuW_navLabel",
			"navList": "_9bHOuW_navList",
			"navTitle": "_9bHOuW_navTitle",
			"options": "_9bHOuW_options",
			"overlay": "_9bHOuW_overlay",
			"panel": "_9bHOuW_panel",
			"rail": "_9bHOuW_rail",
			"railRow": "_9bHOuW_railRow",
			"trigger": "_9bHOuW_trigger",
			"triggerLabel": "_9bHOuW_triggerLabel",
			"triggerRow": "_9bHOuW_triggerRow"
		};
		//#endregion
		...
		*/
		...
		function navIcon(id) {
			...
			if (id === "archived-sessions") return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconArchiveOutline20, {
				className: SettingsRoot_module_css_default.navIcon,
				size: 16
			});
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = ".btqgdG_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "btqgdG_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".GezJqa_section{flex-direction:column;width:100%;display:flex}.GezJqa_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "GezJqa_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = ".BB6IyG_action{align-items:center;gap:8px;min-width:0;display:flex}.BB6IyG_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
