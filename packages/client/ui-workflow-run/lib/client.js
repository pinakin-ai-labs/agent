window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-workflow-run/src/client/WorkflowRunPanel.module.css.mjs
		const css = "._0LNi9q_root{width:100%;min-width:0}._0LNi9q_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}._0LNi9q_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}._0LNi9q_runLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}._0LNi9q_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);font-weight:510;line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}._0LNi9q_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._0LNi9q_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}._0LNi9q_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}._0LNi9q_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}._0LNi9q_phaseLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}._0LNi9q_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:0 auto;overflow:hidden}._0LNi9q_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._0LNi9q_phaseStatus{width:calc(132px + var(--dsh-content-font-delta-secondary,0px) * 10);color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}._0LNi9q_separator{corner-shape:round;background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}._0LNi9q_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}._0LNi9q_phase{min-width:0}._0LNi9q_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}._0LNi9q_memberRow,._0LNi9q_memberButton{width:100%;min-width:0;min-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}._0LNi9q_memberButton{cursor:pointer}._0LNi9q_memberButton ._0LNi9q_memberLabel{color:var(--dsw-alias-link);font-weight:500;text-decoration:none}._0LNi9q_memberButton:hover ._0LNi9q_memberLabel,._0LNi9q_memberButton:focus-visible ._0LNi9q_memberLabel{text-underline-offset:3px;text-decoration:underline dotted}._0LNi9q_dotSlot{width:16px;height:calc(24px + var(--dsh-content-font-delta,0px));flex:none;justify-content:center;align-items:center;display:inline-flex;overflow:hidden}._0LNi9q_memberButton:focus-visible{outline:none}._0LNi9q_memberButton:focus-visible ._0LNi9q_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._0LNi9q_memberLabelWrap{min-width:0;height:calc(24px + var(--dsh-content-font-delta,0px));border-radius:4px;flex:1;align-items:center;padding:0 2px;display:flex;overflow:hidden}._0LNi9q_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._0LNi9q_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}._0LNi9q_empty{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));padding:0}@media (width<=560px){._0LNi9q_phaseList,._0LNi9q_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"dotSlot": "_0LNi9q_dotSlot",
			"empty": "_0LNi9q_empty",
			"memberButton": "_0LNi9q_memberButton",
			"memberLabel": "_0LNi9q_memberLabel",
			"memberLabelWrap": "_0LNi9q_memberLabelWrap",
			"memberRow": "_0LNi9q_memberRow",
			"memberStatus": "_0LNi9q_memberStatus",
			"members": "_0LNi9q_members",
			"phase": "_0LNi9q_phase",
			"phaseCount": "_0LNi9q_phaseCount",
			"phaseHeader": "_0LNi9q_phaseHeader",
			"phaseLeading": "_0LNi9q_phaseLeading",
			"phaseList": "_0LNi9q_phaseList",
			"phaseStatus": "_0LNi9q_phaseStatus",
			"phaseTitle": "_0LNi9q_phaseTitle",
			"root": "_0LNi9q_root",
			"runHeader": "_0LNi9q_runHeader",
			"runLeading": "_0LNi9q_runLeading",
			"runSummary": "_0LNi9q_runSummary",
			"runTitle": "_0LNi9q_runTitle",
			"separator": "_0LNi9q_separator",
			"statusTail": "_0LNi9q_statusTail"
		};
		//#endregion
