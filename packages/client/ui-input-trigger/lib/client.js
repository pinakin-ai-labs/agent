window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-input-trigger/src/client/MenuView.module.css.mjs
		const css = ".Jlcifq_menu{z-index:100;box-sizing:border-box;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsh-scrollbar-width:10px;--dsh-scrollbar-thumb-border:3px;--dsh-scrollbar-track-margin:12px;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);max-height:400px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;right:0;overflow:hidden}.Jlcifq_menu[data-overflow-below]:after{content:\"\";background:linear-gradient(to bottom, transparent, var(--dsw-specific-menu));pointer-events:none;height:16px;position:absolute;bottom:4px;left:4px;right:14px}.Jlcifq_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.Jlcifq_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}.Jlcifq_item.Jlcifq_active{background:var(--dsw-alias-interactive-bg-hover)}.Jlcifq_sectionTitle{min-height:26px;color:var(--dsw-alias-label-tertiary);flex:none;padding:6px 10px 2px;font-size:12px;font-weight:500;line-height:18px}.Jlcifq_sectionTitle:not(:first-child){margin-top:4px}.Jlcifq_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.Jlcifq_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.Jlcifq_itemAlias{text-overflow:ellipsis;white-space:nowrap;max-width:20%;color:var(--dsw-alias-label-tertiary);flex:none;overflow:hidden}.Jlcifq_itemDescription{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}.Jlcifq_trailing{flex:none;align-items:center;gap:4px;margin-left:auto;display:inline-flex}.Jlcifq_drillHintText{color:var(--dsw-alias-label-caption);white-space:nowrap;font-size:11px;line-height:18px;display:none}.Jlcifq_drillHint{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-caption);border-radius:4px;padding:0 5px;font-family:inherit;font-size:11px;line-height:18px;display:none}.Jlcifq_item.Jlcifq_active .Jlcifq_drillHintText,.Jlcifq_item.Jlcifq_active .Jlcifq_drillHint{display:inline-flex}.Jlcifq_drill{width:20px;height:20px;color:var(--dsw-alias-label-caption);border-radius:4px;flex:none;place-items:center;display:inline-grid}.Jlcifq_drill:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.Jlcifq_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}.Jlcifq_skeletonRow{box-sizing:border-box;align-items:center;min-height:40px;padding:8px 10px;display:flex}.Jlcifq_skeletonBar{background:var(--dsw-alias-bg-skeleton);border-radius:4px;height:20px;animation:2s cubic-bezier(.36,0,.64,1) infinite Jlcifq_dsh-menu-skeleton}@keyframes Jlcifq_dsh-menu-skeleton{0%{opacity:1}40%{opacity:.6}80%,to{opacity:1}}.Jlcifq_crumbs{border-bottom:.5px solid var(--dsw-alias-border-l1);flex-wrap:wrap;flex:none;align-items:center;gap:2px;margin-bottom:2px;padding:4px 4px 6px;display:flex}.Jlcifq_crumb{max-width:40%;color:var(--dsw-alias-label-tertiary);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;flex:0 auto;padding:2px 6px;font-family:inherit;font-size:12px;line-height:18px;overflow:hidden}.Jlcifq_crumb:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.Jlcifq_crumbCurrent,.Jlcifq_crumbCurrent:hover{color:var(--dsw-alias-label-primary);cursor:default;background:0 0}.Jlcifq_crumbSeparator{color:var(--dsw-alias-label-caption);flex:none;display:inline-flex}";
		...
		var MenuView_module_css_default = {
			"active": "Jlcifq_active",
			"crumb": "Jlcifq_crumb",
			"crumbCurrent": "Jlcifq_crumbCurrent",
			"crumbSeparator": "Jlcifq_crumbSeparator",
			"crumbs": "Jlcifq_crumbs",
			"drill": "Jlcifq_drill",
			"drillHint": "Jlcifq_drillHint",
			"drillHintText": "Jlcifq_drillHintText",
			"dsh-menu-skeleton": "Jlcifq_dsh-menu-skeleton",
			"groupTitle": "Jlcifq_groupTitle",
			"item": "Jlcifq_item",
			"itemAlias": "Jlcifq_itemAlias",
			"itemDescription": "Jlcifq_itemDescription",
			"itemIcon": "Jlcifq_itemIcon",
			"itemName": "Jlcifq_itemName",
			"menu": "Jlcifq_menu",
			"sectionTitle": "Jlcifq_sectionTitle",
			"skeletonBar": "Jlcifq_skeletonBar",
			"skeletonRow": "Jlcifq_skeletonRow",
			"trailing": "Jlcifq_trailing",
			"viewport": "Jlcifq_viewport"
		};
		//#endregion
						...
						return (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [item.section !== void 0 && item.section !== group.items[index - 1]?.section ? (0, react_jsx_runtime.jsx)("div", {
							...
							children: [
								item.icon !== void 0 && (0, react_jsx_runtime.jsx)("span", {
									...
									"aria-hidden": true,
									children: typeof item.icon === "string" ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.ReferenceIcon, {
										kind: item.icon,
										size: 16
									}) : (0, react_jsx_runtime.jsx)(item.icon, { size: 16 })
								}),
