window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$3 = ".p4smJa_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.p4smJa_field+.p4smJa_field{border-top:.5px solid var(--dsw-alias-border-l2)}.p4smJa_head{align-items:center;gap:8px;display:flex}.p4smJa_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.p4smJa_badges{align-items:center;gap:8px;display:inline-flex}.p4smJa_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.p4smJa_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.p4smJa_reset:disabled{cursor:default}.p4smJa_input{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.p4smJa_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.p4smJa_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.p4smJa_inputInvalid{border-color:var(--dsw-alias-label-error);}.p4smJa_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.p4smJa_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badges": "p4smJa_badges",
			"field": "p4smJa_field",
			"head": "p4smJa_head",
			"hint": "p4smJa_hint",
			"input": "p4smJa_input",
			"inputInvalid": "p4smJa_inputInvalid",
			"invalid": "p4smJa_invalid",
			"label": "p4smJa_label",
			"reset": "p4smJa_reset"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$2 = ".rCJ58W_card{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-3);border-radius:16px;list-style:none;transition:border-color .16s,background .16s}.rCJ58W_card:hover{border-color:var(--dsw-alias-label-dimmed)}.rCJ58W_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.rCJ58W_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.rCJ58W_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.rCJ58W_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.rCJ58W_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.rCJ58W_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.rCJ58W_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.rCJ58W_chevronOpen{transform:rotate(180deg)}.rCJ58W_body{border-top:.5px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.rCJ58W_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.rCJ58W_pending{flex:none}.rCJ58W_footer{border-top:.5px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.rCJ58W_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.rCJ58W_discard,.rCJ58W_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.rCJ58W_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.rCJ58W_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.rCJ58W_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.rCJ58W_discard:disabled,.rCJ58W_save:disabled{opacity:.4;cursor:default}.rCJ58W_discard:focus-visible,.rCJ58W_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"body": "rCJ58W_body",
			"card": "rCJ58W_card",
			"cardOpen": "rCJ58W_cardOpen",
			"chevron": "rCJ58W_chevron",
			"chevronOpen": "rCJ58W_chevronOpen",
			"description": "rCJ58W_description",
			"discard": "rCJ58W_discard",
			"failed": "rCJ58W_failed",
			"footer": "rCJ58W_footer",
			"headText": "rCJ58W_headText",
			"header": "rCJ58W_header",
			"name": "rCJ58W_name",
			"pending": "rCJ58W_pending",
			"readOnly": "rCJ58W_readOnly",
			"save": "rCJ58W_save"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css$1 = ".FMQVTa_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.FMQVTa_heading{margin:0;font-size:18px;font-weight:600}.FMQVTa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.FMQVTa_tabs{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.FMQVTa_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.FMQVTa_tab:hover,.FMQVTa_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.FMQVTa_tab[data-active=true]:after,.FMQVTa_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.FMQVTa_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.FMQVTa_panel{min-width:0;padding-top:2px}.FMQVTa_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.FMQVTa_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"cards": "FMQVTa_cards",
			"empty": "FMQVTa_empty",
			"heading": "FMQVTa_heading",
			"intro": "FMQVTa_intro",
			"panel": "FMQVTa_panel",
			"section": "FMQVTa_section",
			"tab": "FMQVTa_tab",
			"tabs": "FMQVTa_tabs"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-plugins/src/client/SubagentModelSelectionCard.module.css.mjs
		const css = ".VJVblG_permission{gap:6px;padding:12px 0;display:grid}.VJVblG_toggleRow{color:var(--dsw-alias-label-primary);justify-content:space-between;align-items:flex-start;gap:16px;font-size:13px;line-height:1.5;display:flex}.VJVblG_toggleLabel{flex:1;min-width:0}.VJVblG_selection{gap:10px;display:grid}.VJVblG_hint,.VJVblG_notice,.VJVblG_invalid,.VJVblG_conflict{margin:0;font-size:12px;line-height:1.5}.VJVblG_hint,.VJVblG_notice{color:var(--dsw-alias-label-tertiary)}.VJVblG_invalid,.VJVblG_conflict{color:var(--dsw-alias-label-error)}.VJVblG_catalogError{color:var(--dsw-alias-label-error);justify-content:space-between;align-items:center;gap:12px;font-size:12px;display:flex}.VJVblG_catalogError button{color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:0;padding:0}.VJVblG_models{border:.5px solid var(--dsw-alias-border-l4);border-radius:8px;gap:6px;min-width:0;max-height:280px;margin:0;padding:10px;display:grid;overflow:auto}.VJVblG_models legend{color:var(--dsw-alias-label-secondary);padding:0 4px;font-size:12px}.VJVblG_modelGroup{gap:6px;display:grid}.VJVblG_modelGroup+.VJVblG_modelGroup{border-top:.5px solid var(--dsw-alias-border-l3);margin-top:4px;padding-top:10px}.VJVblG_providerName{color:var(--dsw-alias-label-tertiary);padding:0 6px;font-size:11px;font-weight:500}.VJVblG_model{cursor:pointer;border-radius:6px;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px;min-width:0;padding:6px;display:grid}.VJVblG_model:hover{background:var(--dsw-alias-bg-layer-4)}.VJVblG_modelName,.VJVblG_route{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.VJVblG_modelName{color:var(--dsw-alias-label-primary);font-size:13px}.VJVblG_route{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px}.VJVblG_unavailable{color:var(--dsw-alias-label-tertiary);font-size:11px}";
		...
		var SubagentModelSelectionCard_module_css_default = {
			"catalogError": "VJVblG_catalogError",
			"conflict": "VJVblG_conflict",
			"hint": "VJVblG_hint",
			"invalid": "VJVblG_invalid",
			"model": "VJVblG_model",
			"modelGroup": "VJVblG_modelGroup",
			"modelName": "VJVblG_modelName",
			"models": "VJVblG_models",
			"notice": "VJVblG_notice",
			"permission": "VJVblG_permission",
			"providerName": "VJVblG_providerName",
			"route": "VJVblG_route",
			"selection": "VJVblG_selection",
			"toggleLabel": "VJVblG_toggleLabel",
			"toggleRow": "VJVblG_toggleRow",
			"unavailable": "VJVblG_unavailable"
		};
		//#endregion
