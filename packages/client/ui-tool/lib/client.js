window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-tool/src/client/tool/components/AskQuestionCard.module.css.mjs
		const css$3 = ".QQg54q_card{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:16px;max-height:360px;margin:4px 0 4px 4px;padding:16px 20px;display:flex;overflow-y:auto}.QQg54q_item{flex-direction:column;gap:2px;min-width:0;display:flex}.QQg54q_question,.QQg54q_answer{white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.QQg54q_question{color:var(--dsw-alias-label-tertiary)}.QQg54q_answer{color:var(--dsw-alias-label-primary)}.QQg54q_answerLine{display:block}.QQg54q_skipped{color:var(--dsw-alias-label-tertiary)}.QQg54q_verdict{color:var(--dsw-alias-label-primary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.QQg54q_questionList{flex-direction:column;gap:8px;margin:0;padding-left:20px;display:flex}.QQg54q_unansweredQuestion{color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}";
		...
		var AskQuestionCard_module_css_default = {
			"answer": "QQg54q_answer",
			"answerLine": "QQg54q_answerLine",
			"card": "QQg54q_card",
			"item": "QQg54q_item",
			"question": "QQg54q_question",
			"questionList": "QQg54q_questionList",
			"skipped": "QQg54q_skipped",
			"unansweredQuestion": "QQg54q_unansweredQuestion",
			"verdict": "QQg54q_verdict"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$2 = ".otjIlq_root{flex-direction:column;display:flex}.otjIlq_row{position:relative;overflow:hidden}.otjIlq_root[data-state=running] .otjIlq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite otjIlq_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes otjIlq_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.otjIlq_leading{flex-shrink:0}.otjIlq_root[data-tool^=cordis_] .otjIlq_leading,.otjIlq_root[data-tool^=cordis_] .otjIlq_title{color:var(--dsw-alias-state-business-primary)}.otjIlq_root[data-tool^=cordis_] .otjIlq_title{font-weight:500}.otjIlq_root[data-tool^=cordis_] .otjIlq_sep{background:var(--dsw-alias-state-business-primary)}.otjIlq_chevron{color:var(--dsw-alias-label-secondary)}.otjIlq_title{font-weight:400}.otjIlq_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.otjIlq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.otjIlq_summarySuffix{white-space:nowrap;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px}.otjIlq_diffStat{font-family:var(--ds-font-family-code);font-size:calc(var(--dsh-content-font-size-secondary,13px) - 2px);color:var(--dsw-alias-label-caption);margin-left:10px;transform:translateY(.5px)}.otjIlq_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);text-decoration:underline dotted;text-decoration-color:var(--dsw-alias-label-tertiary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:0 auto;margin:0;padding:0;text-decoration-thickness:1px;overflow:hidden}.otjIlq_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.otjIlq_errorSummary{color:var(--dsw-alias-state-error-primary)}.otjIlq_bodyWrap{flex-direction:column;display:flex}.otjIlq_inspectButton{border:.5px solid var(--dsw-alias-border-l3);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.otjIlq_root:hover .otjIlq_inspectButton,.otjIlq_inspectButton:focus-visible{opacity:1}.otjIlq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.otjIlq_bodyScroll{max-height:260px;overflow-y:auto}.otjIlq_ioCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.otjIlq_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.otjIlq_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.otjIlq_ioSection::-webkit-scrollbar-track{margin:6px 0}.otjIlq_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.otjIlq_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:.5px}.otjIlq_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.otjIlq_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.otjIlq_codeBody,.otjIlq_terminalBody,.otjIlq_diffBody,.otjIlq_readBody,.otjIlq_imageBody,.otjIlq_searchBody,.otjIlq_webBody{margin:4px 0 4px 4px}.otjIlq_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.otjIlq_imageLabel{overflow-wrap:anywhere;font:var(--dsw-font-sm-13);color:var(--dsw-alias-label-secondary);margin-bottom:4px}.otjIlq_imageMeta{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary)}.otjIlq_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.otjIlq_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:.5px solid var(--dsw-alias-border-l1)}.otjIlq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"bodyScroll": "otjIlq_bodyScroll",
			"bodyWrap": "otjIlq_bodyWrap",
			"chevron": "otjIlq_chevron",
			"codeBody": "otjIlq_codeBody",
			"diffBody": "otjIlq_diffBody",
			"diffStat": "otjIlq_diffStat",
			"dsh-tool-row-sweep": "otjIlq_dsh-tool-row-sweep",
			"errorSummary": "otjIlq_errorSummary",
			"fileLink": "otjIlq_fileLink",
			"imageBody": "otjIlq_imageBody",
			"imageLabel": "otjIlq_imageLabel",
			"imageMeta": "otjIlq_imageMeta",
			"inspectButton": "otjIlq_inspectButton",
			"ioCard": "otjIlq_ioCard",
			"ioDivider": "otjIlq_ioDivider",
			"ioLabel": "otjIlq_ioLabel",
			"ioSection": "otjIlq_ioSection",
			"ioText": "otjIlq_ioText",
			"leading": "otjIlq_leading",
			"readBody": "otjIlq_readBody",
			"root": "otjIlq_root",
			"row": "otjIlq_row",
			"searchBody": "otjIlq_searchBody",
			"searchRecovery": "otjIlq_searchRecovery",
			"sep": "otjIlq_sep",
			"summary": "otjIlq_summary",
			"summarySuffix": "otjIlq_summarySuffix",
			"terminalBody": "otjIlq_terminalBody",
			"title": "otjIlq_title",
			"visuallyHidden": "otjIlq_visuallyHidden",
			"webBody": "otjIlq_webBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		function ToolRow({ t, variant, toolName, icon, title, summary, summarySuffix, bodyRaw, output, askQuestion, errorSummary, terminal, diff, read, image, renderSlot, loadImage, search, web, state, filePath, filePathLine, onOpenFile, inspect }) {
			...
			const openFile = filePath !== void 0 && onOpenFile !== void 0 && failureLine === null ? (event) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$1 = ".D3WhOq_callRow{border-radius:6px}.D3WhOq_subCalls{border-left:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "D3WhOq_callRow",
			"subCalls": "D3WhOq_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".KqLZVa_card{flex-direction:column;display:flex}.KqLZVa_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:.5px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.KqLZVa_ioCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.KqLZVa_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.KqLZVa_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.KqLZVa_ioSection::-webkit-scrollbar-track{margin:6px 0}.KqLZVa_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.KqLZVa_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:.5px}.KqLZVa_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.KqLZVa_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.KqLZVa_root[data-expandable]{cursor:pointer}.KqLZVa_root{height:calc(24px + var(--dsh-content-font-delta,0px));align-items:center;min-width:0;display:flex;position:relative;overflow:hidden}.KqLZVa_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite KqLZVa_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes KqLZVa_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.KqLZVa_leading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.KqLZVa_leading svg:not([data-state]){width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.KqLZVa_chevron{color:var(--dsw-alias-label-secondary)}.KqLZVa_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.KqLZVa_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.KqLZVa_root:hover .KqLZVa_iconIdle{opacity:0}.KqLZVa_root:hover .KqLZVa_chevronHover{opacity:1}.KqLZVa_title{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none}.KqLZVa_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.KqLZVa_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.KqLZVa_errorSummary{color:var(--dsw-alias-state-error-primary)}.KqLZVa_bodyWrap{flex-direction:column;display:flex}.KqLZVa_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.KqLZVa_card:hover .KqLZVa_inspectButton,.KqLZVa_inspectButton:focus-visible{opacity:1}.KqLZVa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.KqLZVa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "KqLZVa_bodyWrap",
			"card": "KqLZVa_card",
			"chevron": "KqLZVa_chevron",
			"chevronHover": "KqLZVa_chevronHover",
			"dsh-bash-row-sweep": "KqLZVa_dsh-bash-row-sweep",
			"errorSummary": "KqLZVa_errorSummary",
			"iconIdle": "KqLZVa_iconIdle",
			"inspectButton": "KqLZVa_inspectButton",
			"ioCard": "KqLZVa_ioCard",
			"ioDivider": "KqLZVa_ioDivider",
			"ioLabel": "KqLZVa_ioLabel",
			"ioSection": "KqLZVa_ioSection",
			"ioText": "KqLZVa_ioText",
			"leading": "KqLZVa_leading",
			"root": "KqLZVa_root",
			"sep": "KqLZVa_sep",
			"summary": "KqLZVa_summary",
			"terminal": "KqLZVa_terminal",
			"title": "KqLZVa_title",
			"visuallyHidden": "KqLZVa_visuallyHidden"
		};
		//#endregion
