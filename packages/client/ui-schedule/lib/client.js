window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-schedule/src/client/ScheduleCatalogAction.module.css.mjs
		const css = ".ek0TLq_root{position:relative}.ek0TLq_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:4px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.ek0TLq_trigger:hover,.ek0TLq_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.ek0TLq_trigger svg{flex:none}.ek0TLq_trigger>svg:last-child{transition:transform .12s}.ek0TLq_triggerOpen{transform:rotate(180deg)}.ek0TLq_count{margin-left:2px}.ek0TLq_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(336px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;gap:2px;margin:0;padding:4px;list-style:none;display:flex;position:fixed;overflow:auto}.ek0TLq_row{box-sizing:border-box;width:100%;min-height:54px;color:var(--dsw-alias-label-primary);border-radius:8px;flex-direction:column;flex-shrink:0;gap:3px;padding:8px 10px;display:flex}.ek0TLq_rowOverdue{background:var(--dsw-alias-state-warn-tertiary)}.ek0TLq_status{color:var(--dsw-alias-label-tertiary);align-items:center;gap:5px;font-size:11px;line-height:16px;display:inline-flex}.ek0TLq_statusDot{corner-shape:round;background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:8px;height:8px}.ek0TLq_rowOverdue .ek0TLq_status{color:var(--dsw-alias-state-warn-label)}.ek0TLq_rowOverdue .ek0TLq_statusDot{background:var(--dsw-alias-state-warn-primary)}.ek0TLq_prompt{overflow-wrap:anywhere;white-space:normal;font-size:13px;line-height:18px}.ek0TLq_metadata{min-width:0;color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:center;gap:5px;font-size:11px;line-height:16px;display:flex}.ek0TLq_relativeOverdue{color:var(--dsw-alias-state-warn-label)}";
		...
		var ScheduleCatalogAction_module_css_default = {
			"count": "ek0TLq_count",
			"menu": "ek0TLq_menu",
			"metadata": "ek0TLq_metadata",
			"prompt": "ek0TLq_prompt",
			"relativeOverdue": "ek0TLq_relativeOverdue",
			"root": "ek0TLq_root",
			"row": "ek0TLq_row",
			"rowOverdue": "ek0TLq_rowOverdue",
			"status": "ek0TLq_status",
			"statusDot": "ek0TLq_statusDot",
			"trigger": "ek0TLq_trigger",
			"triggerOpen": "ek0TLq_triggerOpen"
		};
		//#endregion
