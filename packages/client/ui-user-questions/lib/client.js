window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = "._6CYK4G_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}._6CYK4G_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}._6CYK4G_card,._6CYK4G_card *{box-sizing:border-box}._6CYK4G_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}._6CYK4G_dot{corner-shape:round;background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}._6CYK4G_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}._6CYK4G_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}._6CYK4G_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}._6CYK4G_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}._6CYK4G_discuss{color:var(--dsw-alias-label-secondary);gap:6px}._6CYK4G_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){._6CYK4G_card{border-radius:16px}._6CYK4G_body{padding:10px 12px 4px}._6CYK4G_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"actions": "_6CYK4G_actions",
			"body": "_6CYK4G_body",
			"card": "_6CYK4G_card",
			"discuss": "_6CYK4G_discuss",
			"dot": "_6CYK4G_dot",
			"feedback": "_6CYK4G_feedback",
			"footer": "_6CYK4G_footer",
			"frame": "_6CYK4G_frame",
			"strip": "_6CYK4G_strip"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".ViCMoG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.ViCMoG_card{width:100%;max-width:var(--dsh-chat-content-width);--dsw-elevation-stroke-color:var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-elevation-panel);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.ViCMoG_card,.ViCMoG_card *{box-sizing:border-box}.ViCMoG_cardMinimized{max-height:none}.ViCMoG_cardMinimized .ViCMoG_header{padding-bottom:14px}.ViCMoG_headerActions{flex-shrink:0;align-items:center;gap:4px;display:flex}.ViCMoG_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.ViCMoG_headingBlock{min-width:0}.ViCMoG_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.ViCMoG_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.ViCMoG_detail{margin:0 2px 8px}.ViCMoG_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.ViCMoG_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.ViCMoG_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.ViCMoG_iconButton{corner-shape:round;width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.ViCMoG_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.ViCMoG_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.ViCMoG_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.ViCMoG_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.ViCMoG_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.ViCMoG_option:hover:not(:disabled),.ViCMoG_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.ViCMoG_optionSelected{border-color:var(--dsw-alias-border-l2)}.ViCMoG_option:disabled{cursor:default}.ViCMoG_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.ViCMoG_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.ViCMoG_checkbox:before{content:\"\";border:.5px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.ViCMoG_checkbox>svg{grid-area:1/1}.ViCMoG_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.ViCMoG_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.ViCMoG_optionCopy{flex:1;min-width:0}.ViCMoG_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.ViCMoG_optionLabel{font-size:14px;font-weight:500;line-height:24px}.ViCMoG_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.ViCMoG_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.ViCMoG_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.ViCMoG_customRow:hover,.ViCMoG_customRow:focus-within,.ViCMoG_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.ViCMoG_customRow:focus-within,.ViCMoG_customRowActive{border-color:var(--dsw-alias-border-l2)}.ViCMoG_field{--dsh-answer-field-padding:0;min-width:0;display:grid}.ViCMoG_field>*{min-width:0;padding:var(--dsh-answer-field-padding);font:inherit;white-space:pre-wrap;word-break:break-word;overflow-wrap:anywhere;grid-area:1/1;font-size:14px;line-height:24px}.ViCMoG_fieldMirror{box-sizing:content-box;visibility:hidden;max-height:144px;overflow:hidden}.ViCMoG_fieldInput{resize:none;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);background:0 0;border:none;outline:none;overflow-y:auto}.ViCMoG_fieldInput::placeholder{color:var(--dsw-alias-label-caption)}.ViCMoG_customInline{flex:1}.ViCMoG_customBlock{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-module-platform);--dsh-answer-field-padding:8px 12px;border-radius:10px;flex-shrink:0;min-height:64px;margin:0 12px}.ViCMoG_customBlock:focus-within{border-color:var(--dsw-alias-state-business-primary)}.ViCMoG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.ViCMoG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.ViCMoG_card{border-radius:16px}.ViCMoG_header{padding:10px 12px 0 18px}.ViCMoG_options{padding:4px 8px}.ViCMoG_title{font-size:15px;line-height:21px}.ViCMoG_option,.ViCMoG_customRow{padding:8px 6px}.ViCMoG_footer{align-items:flex-end;padding:0 10px}.ViCMoG_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.ViCMoG_option,.ViCMoG_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			...
			"body": "ViCMoG_body",
			"card": "ViCMoG_card",
			"cardMinimized": "ViCMoG_cardMinimized",
			"checkbox": "ViCMoG_checkbox",
			"checkboxChecked": "ViCMoG_checkboxChecked",
			"customBlock": "ViCMoG_customBlock",
			"customInline": "ViCMoG_customInline",
			"customRow": "ViCMoG_customRow",
			"customRowActive": "ViCMoG_customRowActive",
			"description": "ViCMoG_description",
			"detail": "ViCMoG_detail",
			"eyebrow": "ViCMoG_eyebrow",
			"feedback": "ViCMoG_feedback",
			"field": "ViCMoG_field",
			"fieldInput": "ViCMoG_fieldInput",
			"fieldMirror": "ViCMoG_fieldMirror",
			"footer": "ViCMoG_footer",
			"footerActions": "ViCMoG_footerActions",
			"frame": "ViCMoG_frame",
			"header": "ViCMoG_header",
			"headerActions": "ViCMoG_headerActions",
			"headingBlock": "ViCMoG_headingBlock",
			"iconButton": "ViCMoG_iconButton",
			"number": "ViCMoG_number",
			"option": "ViCMoG_option",
			"optionCopy": "ViCMoG_optionCopy",
			"optionLabel": "ViCMoG_optionLabel",
			"optionLine": "ViCMoG_optionLine",
			"optionSelected": "ViCMoG_optionSelected",
			"options": "ViCMoG_options",
			"pager": "ViCMoG_pager",
			"progress": "ViCMoG_progress",
			"title": "ViCMoG_title"
		};
		//#endregion
