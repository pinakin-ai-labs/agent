window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = "._0JebEW_dialog._0JebEW_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}._0JebEW_editorScope{display:contents}._0JebEW_header{border-bottom:.5px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}._0JebEW_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}._0JebEW_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}._0JebEW_crumbBar:has(._0JebEW_crumbEditZone:enabled:hover),._0JebEW_crumbBar:has(._0JebEW_crumbEditZone:focus-visible),._0JebEW_crumbBar:has(._0JebEW_pathInput){border-color:var(--dsw-alias-border-l2)}._0JebEW_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}._0JebEW_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}._0JebEW_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}._0JebEW_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}._0JebEW_crumb:hover{color:var(--dsw-alias-label-primary)}._0JebEW_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}._0JebEW_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}._0JebEW_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}._0JebEW_crumbEditZone:enabled:hover ._0JebEW_crumbEditGlyph,._0JebEW_crumbEditZone:focus-visible ._0JebEW_crumbEditGlyph{color:var(--dsw-alias-label-primary)}._0JebEW_crumbEditZone:disabled{cursor:default}._0JebEW_crumbEditZone:disabled ._0JebEW_crumbEditGlyph{color:var(--dsw-alias-label-caption)}._0JebEW_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}._0JebEW_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}._0JebEW_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}._0JebEW_divider{background:var(--dsw-alias-border-l3);flex:none;width:.5px}._0JebEW_rowSeat{flex:none;display:flex}._0JebEW_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}._0JebEW_row:hover{background:var(--dsw-alias-interactive-bg-hover)}._0JebEW_rowSelected,._0JebEW_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}._0JebEW_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}._0JebEW_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}._0JebEW_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}._0JebEW_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}._0JebEW_status,._0JebEW_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}._0JebEW_status{color:var(--dsw-alias-label-secondary)}._0JebEW_error{color:var(--dsw-alias-state-error-primary)}._0JebEW_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}._0JebEW_footerBar{border-top:.5px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}._0JebEW_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}._0JebEW_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}._0JebEW_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}._0JebEW_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}._0JebEW_footerGap{flex:1 1 0}._0JebEW_footerAction{min-width:72px}._0JebEW_createDialog._0JebEW_createDialog{gap:0;width:min(380px,100%);padding:0}._0JebEW_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}._0JebEW_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}._0JebEW_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}._0JebEW_createInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}._0JebEW_createInput::placeholder{color:var(--dsw-alias-label-caption)}._0JebEW_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "_0JebEW_column",
			"content": "_0JebEW_content",
			"createActions": "_0JebEW_createActions",
			"createBody": "_0JebEW_createBody",
			"createDialog": "_0JebEW_createDialog",
			"createIn": "_0JebEW_createIn",
			"createInput": "_0JebEW_createInput",
			"createTitle": "_0JebEW_createTitle",
			"crumb": "_0JebEW_crumb",
			"crumbBar": "_0JebEW_crumbBar",
			"crumbChevron": "_0JebEW_crumbChevron",
			"crumbEditGlyph": "_0JebEW_crumbEditGlyph",
			"crumbEditZone": "_0JebEW_crumbEditZone",
			"crumbSeat": "_0JebEW_crumbSeat",
			"crumbTrail": "_0JebEW_crumbTrail",
			"dialog": "_0JebEW_dialog",
			"divider": "_0JebEW_divider",
			"editorScope": "_0JebEW_editorScope",
			"error": "_0JebEW_error",
			"footerAction": "_0JebEW_footerAction",
			"footerBar": "_0JebEW_footerBar",
			"footerGap": "_0JebEW_footerGap",
			"header": "_0JebEW_header",
			"loadingFloat": "_0JebEW_loadingFloat",
			"millerRow": "_0JebEW_millerRow",
			"pathInput": "_0JebEW_pathInput",
			"row": "_0JebEW_row",
			"rowChevron": "_0JebEW_rowChevron",
			"rowIcon": "_0JebEW_rowIcon",
			"rowIconSelected": "_0JebEW_rowIconSelected",
			"rowName": "_0JebEW_rowName",
			"rowSeat": "_0JebEW_rowSeat",
			"rowSelected": "_0JebEW_rowSelected",
			"showHiddenToggle": "_0JebEW_showHiddenToggle",
			"showHiddenToggleActive": "_0JebEW_showHiddenToggleActive",
			"status": "_0JebEW_status",
			"title": "_0JebEW_title"
		};
		//#endregion
		...
		*/
		...
		function failureText(error) {
			if (error !== null && typeof error === "object" && "rpcError" in error) {
				...
				if (rpcError !== null && typeof rpcError === "object" && "message" in rpcError && typeof rpcError.message === "string") return rpcError.message;
			}
