 ...
 */
export function writeDefaultPreset(ctx, id) {
 ...
 * @returns the failure message, or undefined once the write landed.
 */
export function writeModeSelectionEnabled(ctx, enabled) {
    return writeAgentPresetSettings(ctx, { modeSelectionEnabled: enabled });
}
const EMPTY_ROSTER = { presets: [], authorable: false, modeSelectionEnabled: false };
/**
 ...
 */
export async function beginRosterRead(ctx, store) {
