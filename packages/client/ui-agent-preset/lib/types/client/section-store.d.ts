...
export declare class AgentPresetSectionController {
    ...
    private confirmEffectiveDefault;
    /**
     ...
     */
    setPickerVisible(showPicker: boolean, syncBlankSession?: (id: string) => Promise<string | undefined>): Promise<void>;
    private patchCopy;
    /**
     ...
     */
    makeDefault(id: string, syncBlankSession?: (id: string) => Promise<string | undefined>): Promise<void>;
}
