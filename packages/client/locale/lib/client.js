window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/locale/src/client/LanguageRow.module.css.mjs
		const css = ".IXp7tG_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.IXp7tG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.IXp7tG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.IXp7tG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.IXp7tG_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.IXp7tG_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"chevron": "IXp7tG_chevron",
			"row": "IXp7tG_row",
			"rowText": "IXp7tG_rowText",
			"selector": "IXp7tG_selector",
			"title": "IXp7tG_title"
		};
		//#endregion
