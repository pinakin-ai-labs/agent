window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-settings-plugin-inventory/src/client/PluginInventorySettingsTab.module.css.mjs
		const css = "._0yMdmG_section{width:100%;max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:14px;display:flex}._0yMdmG_catalogHeading h3,._0yMdmG_status,._0yMdmG_failure p{margin:0}._0yMdmG_status,._0yMdmG_failure{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}._0yMdmG_failure{color:var(--dsw-alias-state-error-primary);align-items:center;gap:10px;display:flex}._0yMdmG_failure button{border:.5px solid var(--dsw-alias-border-l3);color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;padding:4px 10px}._0yMdmG_catalog{flex-direction:column;gap:12px;display:flex}._0yMdmG_search{width:100%;color:var(--dsw-alias-label-tertiary);align-items:center;display:flex;position:relative}._0yMdmG_search>svg{pointer-events:none;position:absolute;left:12px}._0yMdmG_search input{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);width:100%;height:36px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:10px;outline:none;padding:0 34px 0 36px;font-size:13px}._0yMdmG_search input::placeholder{color:var(--dsw-alias-label-tertiary)}._0yMdmG_search input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}._0yMdmG_catalogHeading{align-items:baseline;gap:7px;padding:0 2px;display:flex}._0yMdmG_catalogHeading h3{font-size:13px;font-weight:600;line-height:20px}._0yMdmG_catalogHeading span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}._0yMdmG_cards{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;margin:0;padding:0;list-style:none;display:grid}._0yMdmG_card{min-width:0;box-shadow:var(--dsw-elevation-stroke);background:var(--dsw-alias-bg-layer-3);border:0;border-radius:14px;overflow:hidden}._0yMdmG_card[data-open=true]{--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);box-shadow:var(--dsw-elevation-panel)}._0yMdmG_cardContent{box-sizing:border-box;width:100%;min-height:52px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex-direction:column;align-items:stretch;padding:12px 14px;display:flex}._0yMdmG_cardContent:hover,._0yMdmG_card[data-open=true]>._0yMdmG_cardContent{background:var(--dsw-alias-interactive-bg-hover)}._0yMdmG_cardContent:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}._0yMdmG_cardMainRow{justify-content:space-between;align-items:center;gap:12px;min-width:0;display:flex}._0yMdmG_cardTitle,._0yMdmG_cardIdentity{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._0yMdmG_cardTitle{flex:1;min-width:0;font-size:14px;font-weight:600;line-height:20px}._0yMdmG_cardIdentity{width:100%;color:var(--dsw-alias-label-tertiary);font-family:var(--ds-font-family-code);font-size:11px;line-height:16px;display:block}._0yMdmG_cardTrailing{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:7px;display:inline-flex}._0yMdmG_phaseDot{flex:none;display:inline-flex}._0yMdmG_group{flex-direction:column;gap:10px;display:flex}._0yMdmG_groupTitleRow{align-items:center;gap:8px;min-height:32px;display:flex}._0yMdmG_group+._0yMdmG_group{border-top:.5px solid var(--dsw-alias-border-l2);padding-top:14px}._0yMdmG_headerEnd{margin-left:auto}._0yMdmG_groupToggle{color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex:none;align-items:center;gap:8px;padding:0;display:flex}._0yMdmG_groupToggle:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._0yMdmG_groupToggle>._0yMdmG_chevron{transform:rotate(-90deg)}._0yMdmG_groupToggle[aria-expanded=true]>._0yMdmG_chevron{transform:none}._0yMdmG_groupTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._0yMdmG_groupSub{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex-wrap:wrap;gap:4px 8px;margin:-6px 0 0 20px;font-size:12px;line-height:18px;display:flex}._0yMdmG_failedCount{color:var(--dsw-alias-state-error-primary)}._0yMdmG_switcher{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);height:36px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border:none;border-radius:18px;flex:none;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._0yMdmG_switcher:hover{background:var(--dsw-alias-interactive-bg-hover)}._0yMdmG_switcher:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._0yMdmG_switcher>._0yMdmG_chevron{flex:none}._0yMdmG_switcherLabel{text-overflow:ellipsis;max-width:240px;overflow:hidden}._0yMdmG_groupBody{flex-direction:column;gap:10px;display:flex}._0yMdmG_brokenNote{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 8%, transparent);color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;white-space:pre-line;border-radius:8px;margin:0;padding:8px 10px;font-size:12.5px;line-height:18px}._0yMdmG_hint{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:baseline;gap:4px 8px;margin:0;font-size:12.5px;line-height:18px;display:flex}._0yMdmG_jumpLink{color:var(--dsw-alias-state-business-primary);font:inherit;cursor:pointer;background:0 0;border:0;padding:0;font-size:12.5px}._0yMdmG_enabledIn{flex-wrap:wrap;align-items:baseline;gap:4px 10px;display:flex}._0yMdmG_card[data-failed=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent)}._0yMdmG_chevron{color:var(--dsw-alias-label-tertiary);flex:none}._0yMdmG_card[data-open=true] ._0yMdmG_chevron{transform:rotate(180deg)}._0yMdmG_cardDetails{border-top:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);padding:10px 14px 12px}._0yMdmG_entryValue{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code);font-size:12px;line-height:18px;display:block}._0yMdmG_details{grid-template-columns:76px minmax(0,1fr);gap:6px 10px;margin:8px 0 0;display:grid}._0yMdmG_details div{display:contents}._0yMdmG_details dt{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}._0yMdmG_details dd{overflow-wrap:anywhere;min-width:0;color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:17px}._0yMdmG_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:no-preference){._0yMdmG_chevron{transition:transform .14s var(--ds-ease-in-out)}}@media (width<=680px){._0yMdmG_cards{grid-template-columns:minmax(0,1fr)}}";
		...
		var PluginInventorySettingsTab_module_css_default = {
			"brokenNote": "_0yMdmG_brokenNote",
			"card": "_0yMdmG_card",
			"cardContent": "_0yMdmG_cardContent",
			"cardDetails": "_0yMdmG_cardDetails",
			"cardIdentity": "_0yMdmG_cardIdentity",
			"cardMainRow": "_0yMdmG_cardMainRow",
			"cardTitle": "_0yMdmG_cardTitle",
			"cardTrailing": "_0yMdmG_cardTrailing",
			"cards": "_0yMdmG_cards",
			"catalog": "_0yMdmG_catalog",
			"catalogHeading": "_0yMdmG_catalogHeading",
			"chevron": "_0yMdmG_chevron",
			"details": "_0yMdmG_details",
			"enabledIn": "_0yMdmG_enabledIn",
			"entryValue": "_0yMdmG_entryValue",
			"failedCount": "_0yMdmG_failedCount",
			"failure": "_0yMdmG_failure",
			"group": "_0yMdmG_group",
			"groupBody": "_0yMdmG_groupBody",
			"groupSub": "_0yMdmG_groupSub",
			"groupTitle": "_0yMdmG_groupTitle",
			"groupTitleRow": "_0yMdmG_groupTitleRow",
			"groupToggle": "_0yMdmG_groupToggle",
			"headerEnd": "_0yMdmG_headerEnd",
			"hint": "_0yMdmG_hint",
			"jumpLink": "_0yMdmG_jumpLink",
			"phaseDot": "_0yMdmG_phaseDot",
			"search": "_0yMdmG_search",
			"section": "_0yMdmG_section",
			"status": "_0yMdmG_status",
			"switcher": "_0yMdmG_switcher",
			"switcherLabel": "_0yMdmG_switcherLabel",
			"visuallyHidden": "_0yMdmG_visuallyHidden"
		};
		//#endregion
