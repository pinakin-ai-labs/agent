window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".Yr-Ajq_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.Yr-Ajq_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:Yr-Ajq_trajectory-table/inline-size}.Yr-Ajq_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.Yr-Ajq_historyLoadingBar{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.Yr-Ajq_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);corner-shape:round;border-radius:50%;width:10px;height:10px;animation:.7s linear infinite Yr-Ajq_history-loading-spin}.Yr-Ajq_table tbody .Yr-Ajq_historyLoadRow td{height:30px;padding:0}.Yr-Ajq_table tbody .Yr-Ajq_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.Yr-Ajq_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.Yr-Ajq_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.Yr-Ajq_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.Yr-Ajq_historyLoadButton:disabled{cursor:default}.Yr-Ajq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.Yr-Ajq_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes Yr-Ajq_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.Yr-Ajq_historyLoadingSpinner{animation:none}}.Yr-Ajq_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.Yr-Ajq_eventColumn{width:122px}.Yr-Ajq_eventColumn:where(:lang(zh)){width:84px}.Yr-Ajq_contentColumn{width:auto}.Yr-Ajq_table th{z-index:3;box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.Yr-Ajq_eventHeader{text-align:right!important;padding-right:4px!important}.Yr-Ajq_table td{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.Yr-Ajq_table tbody .Yr-Ajq_virtualSpacer{pointer-events:none}.Yr-Ajq_table tbody .Yr-Ajq_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.Yr-Ajq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.Yr-Ajq_table tbody tr[data-timeline-focus=outside]{opacity:.24}.Yr-Ajq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.Yr-Ajq_table tbody tr[data-request-only=true]:hover{background:0 0}.Yr-Ajq_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.Yr-Ajq_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.Yr-Ajq_table tbody tr[data-request-only=true] .Yr-Ajq_turnRail{top:-15px;bottom:0}.Yr-Ajq_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.Yr-Ajq_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.Yr-Ajq_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.Yr-Ajq_requestBoundaryControl:before{corner-shape:round;background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.Yr-Ajq_requestBoundaryControl:after{border:.5px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.Yr-Ajq_requestBoundaryControl:hover:before,.Yr-Ajq_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.Yr-Ajq_requestBoundaryControlActive:before,.Yr-Ajq_requestBoundaryControlActive:hover:before,.Yr-Ajq_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.Yr-Ajq_requestBoundaryControl[data-request-status=error]:before,.Yr-Ajq_requestBoundaryControl[data-request-status=error]:hover:before,.Yr-Ajq_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.Yr-Ajq_requestBoundaryControl:hover:after,.Yr-Ajq_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.Yr-Ajq_requestBoundaryControl:focus-visible{outline:none}.Yr-Ajq_table tbody tr:has(.Yr-Ajq_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.Yr-Ajq_event{position:relative}.Yr-Ajq_turnRail,.Yr-Ajq_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.Yr-Ajq_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.Yr-Ajq_table tbody tr[data-turn-end=true] .Yr-Ajq_turnRail{bottom:0}.Yr-Ajq_selectionRail{z-index:5;width:3px;top:0;bottom:0}.Yr-Ajq_table tbody tr[data-error=true] .Yr-Ajq_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.Yr-Ajq_table tbody tr[data-error=true] .Yr-Ajq_selectionRail{background:var(--dsw-alias-state-error-primary)}.Yr-Ajq_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.Yr-Ajq_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.Yr-Ajq_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.Yr-Ajq_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.Yr-Ajq_turnLabelFull,.Yr-Ajq_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.Yr-Ajq_turnLabelCompact{opacity:0;max-width:0}.Yr-Ajq_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.Yr-Ajq_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.Yr-Ajq_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.Yr-Ajq_kindSlot:where(:lang(zh)){width:44px}.Yr-Ajq_kindSlot [role=tooltip]{background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-elevation-panel);color:var(--dsw-alias-label-primary);border:0}.Yr-Ajq_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.Yr-Ajq_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.Yr-Ajq_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.Yr-Ajq_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.Yr-Ajq_table .Yr-Ajq_kindSlot .Yr-Ajq_message{justify-content:center;width:100%}@container Yr-Ajq_trajectory-table (width<=620px){.Yr-Ajq_eventColumn{width:50px}.Yr-Ajq_event{padding-left:28px!important;padding-right:3px!important}.Yr-Ajq_requestBoundaryControl{--request-boundary-base-left:6px}.Yr-Ajq_kindSlot{width:19px}.Yr-Ajq_kindTag,.Yr-Ajq_table .Yr-Ajq_kindSlot .Yr-Ajq_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.Yr-Ajq_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.Yr-Ajq_kindTagLabel,.Yr-Ajq_turnLabelFull{opacity:0;max-width:0}.Yr-Ajq_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.Yr-Ajq_eventColumn,.Yr-Ajq_event,.Yr-Ajq_requestBoundaryControl,.Yr-Ajq_kindSlot,.Yr-Ajq_kindTag,.Yr-Ajq_kindTagIcon,.Yr-Ajq_kindTagLabel,.Yr-Ajq_turnLabelFull,.Yr-Ajq_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.Yr-Ajq_eventColumn,.Yr-Ajq_kindSlot{transition-property:width}.Yr-Ajq_event{transition-property:padding-right,padding-left}.Yr-Ajq_requestBoundaryControl{transition-property:left}.Yr-Ajq_kindTag{transition-property:padding-right,padding-left}.Yr-Ajq_kindTagIcon{transition-property:width,opacity,transform}.Yr-Ajq_kindTagLabel,.Yr-Ajq_turnLabelFull,.Yr-Ajq_turnLabelCompact{transition-property:max-width,opacity}}.Yr-Ajq_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.Yr-Ajq_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.Yr-Ajq_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.Yr-Ajq_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.Yr-Ajq_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.Yr-Ajq_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.Yr-Ajq_promptDiffSection{min-width:0}.Yr-Ajq_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.Yr-Ajq_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.Yr-Ajq_promptDiff span{min-width:max-content;padding:0 6px;display:block}.Yr-Ajq_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.Yr-Ajq_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.Yr-Ajq_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.Yr-Ajq_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.Yr-Ajq_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.Yr-Ajq_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.Yr-Ajq_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.Yr-Ajq_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.Yr-Ajq_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.Yr-Ajq_table tbody tr[data-collapsed-summary=turn] td,.Yr-Ajq_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.Yr-Ajq_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.Yr-Ajq_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.Yr-Ajq_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.Yr-Ajq_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.Yr-Ajq_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.Yr-Ajq_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Yr-Ajq_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.Yr-Ajq_resultRequest,.Yr-Ajq_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Yr-Ajq_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.Yr-Ajq_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.Yr-Ajq_table tbody tr[data-kind=tool] .Yr-Ajq_contentText,.Yr-Ajq_table tbody tr[data-kind=subtool] .Yr-Ajq_contentText,.Yr-Ajq_table tbody tr[data-kind=tool] .Yr-Ajq_resultPreview,.Yr-Ajq_table tbody tr[data-kind=subtool] .Yr-Ajq_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.Yr-Ajq_table tbody tr[data-kind=subtool] .Yr-Ajq_content{padding-left:26px}.Yr-Ajq_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.Yr-Ajq_noOutputText{color:var(--dsw-alias-label-caption)}.Yr-Ajq_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.Yr-Ajq_error,.Yr-Ajq_overview dd.Yr-Ajq_error,.Yr-Ajq_details .Yr-Ajq_errorPayload{color:var(--dsw-alias-state-error-primary)}.Yr-Ajq_details .Yr-Ajq_errorPayload .Yr-Ajq_resultBlockText{color:inherit}.Yr-Ajq_details .Yr-Ajq_jsonPayload.Yr-Ajq_errorPayload,.Yr-Ajq_details .Yr-Ajq_jsonPreview.Yr-Ajq_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.Yr-Ajq_details{border-left:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.Yr-Ajq_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.Yr-Ajq_detailsResizeHandle:focus-visible{outline:none}.Yr-Ajq_detailsHeader{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.Yr-Ajq_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.Yr-Ajq_requestDetailsDot{corner-shape:round;background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.Yr-Ajq_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.Yr-Ajq_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Yr-Ajq_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.Yr-Ajq_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Yr-Ajq_detailTabs{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.Yr-Ajq_detailTabs::-webkit-scrollbar{display:none}.Yr-Ajq_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.Yr-Ajq_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Yr-Ajq_detailTabActive{color:var(--dsw-alias-state-business-primary)}.Yr-Ajq_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.Yr-Ajq_close:focus-visible,.Yr-Ajq_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Yr-Ajq_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.Yr-Ajq_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.Yr-Ajq_detailBodySummary>.Yr-Ajq_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;padding-bottom:0;overflow:auto}.Yr-Ajq_detailBodySummary>.Yr-Ajq_compactedSummary{flex:1;min-height:0;overflow:auto}.Yr-Ajq_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.Yr-Ajq_summaryScrollRegion:hover,.Yr-Ajq_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.Yr-Ajq_compactedSummary .Yr-Ajq_markdownPayload{padding-right:18px}.Yr-Ajq_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.Yr-Ajq_overviewParentLinks{gap:14px;display:flex}.Yr-Ajq_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.Yr-Ajq_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.Yr-Ajq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.Yr-Ajq_overviewHierarchyNavLink:hover .Yr-Ajq_overviewHierarchyJumpIconTight,.Yr-Ajq_overviewHierarchyNavLink:focus-visible .Yr-Ajq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.Yr-Ajq_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Yr-Ajq_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.Yr-Ajq_overview>.Yr-Ajq_requestTokenDetail dt{padding-left:12px}.Yr-Ajq_usagePanel{padding:4px 0 10px}.Yr-Ajq_usageGroup+.Yr-Ajq_usageGroup{margin-top:8px}.Yr-Ajq_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.Yr-Ajq_usageGroup .Yr-Ajq_overview{padding:0}.Yr-Ajq_overview dt{color:var(--dsw-alias-label-tertiary)}.Yr-Ajq_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.Yr-Ajq_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.Yr-Ajq_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Yr-Ajq_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.Yr-Ajq_overviewSection{flex-direction:column;flex:1 1 0;min-height:24px;max-height:max-content;display:flex;overflow:hidden}.Yr-Ajq_overviewSection+.Yr-Ajq_overviewSection{padding-top:2px}.Yr-Ajq_overviewHeading{box-sizing:border-box;width:100%;height:24px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.Yr-Ajq_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.Yr-Ajq_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.Yr-Ajq_overviewTitle:hover .Yr-Ajq_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.Yr-Ajq_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Yr-Ajq_overviewTitle:focus-visible .Yr-Ajq_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.Yr-Ajq_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.Yr-Ajq_overviewPreview[data-scroll-more]{mask-image:linear-gradient(#000 calc(100% - 12px),#0000)}.Yr-Ajq_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.Yr-Ajq_programDescription{color:var(--dsw-alias-label-primary);font:var(--dsw-font-xs-13);white-space:pre-wrap;overflow-wrap:anywhere;flex:none;margin:0;padding:8px 14px 2px}.Yr-Ajq_programIcon{vertical-align:-2px;margin-right:4px}.Yr-Ajq_programSummary{font-family:var(--dsw-font-family);margin-left:5px}.Yr-Ajq_detailBodyProgram,.Yr-Ajq_programPanel{flex-direction:column;min-height:0;display:flex;overflow:hidden}.Yr-Ajq_programPanel{background:var(--dsw-alias-bg-layer-1);flex:1}.Yr-Ajq_programActions{flex:none;align-items:center;gap:4px;height:16px;margin-left:auto;padding-right:14px;display:inline-flex}.Yr-Ajq_programLanguage{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);padding-right:4px}.Yr-Ajq_programAction{box-sizing:border-box;width:20px;height:16px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;display:inline-flex}.Yr-Ajq_programAction:hover{color:var(--dsw-alias-label-primary)}.Yr-Ajq_programAction[aria-pressed=true]{color:var(--dsw-alias-state-business-primary)}.Yr-Ajq_programAction[data-state=failed]{color:var(--dsw-alias-state-error-primary)}.Yr-Ajq_programAction:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Yr-Ajq_programContent{min-width:0;min-height:0}.Yr-Ajq_programPanel>.Yr-Ajq_programContent{overscroll-behavior:contain;flex:1;overflow:auto}.Yr-Ajq_programSource{background:var(--dsw-alias-bg-layer-1);--dsl-code-block-line-white-space:pre;border-radius:0;margin:0!important}.Yr-Ajq_programSource :where(pre){font:12px/16px var(--ds-font-family-code);overflow-wrap:normal;word-break:normal;tab-size:2;border-radius:0;padding:2px 14px 8px;overflow:visible;background:var(--dsw-alias-bg-layer-1)!important}.Yr-Ajq_programSource pre code>.line{box-sizing:border-box;width:max-content;min-width:100%}.Yr-Ajq_programContent[data-wrap=true] .Yr-Ajq_programSource{--dsl-code-block-line-white-space:pre-wrap}.Yr-Ajq_programContent[data-wrap=true] .Yr-Ajq_programSource pre code>.line{overflow-wrap:anywhere;word-break:break-all;width:auto}.Yr-Ajq_programOutput{color:var(--dsw-alias-label-primary);font:12px/16px var(--ds-font-family-code);white-space:pre-wrap;overflow-wrap:anywhere;margin:0;padding:2px 14px 8px}.Yr-Ajq_programError:first-line{color:var(--dsw-alias-state-error-primary);font-weight:600}.Yr-Ajq_overviewPreview .Yr-Ajq_jsonPreview>:first-child,.Yr-Ajq_overviewPreview .Yr-Ajq_schemaTree>:first-child{padding-top:2px;padding-bottom:0}.Yr-Ajq_overviewPreview .Yr-Ajq_schemaTree{margin-bottom:0}.Yr-Ajq_overviewPreview .Yr-Ajq_overview{padding:2px 0 0}.Yr-Ajq_overviewPreview .Yr-Ajq_overview>div{min-height:22px}.Yr-Ajq_markdownPreview,.Yr-Ajq_markdownPayload{color:var(--dsw-alias-label-primary)}.Yr-Ajq_markdownPreview>div,.Yr-Ajq_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.Yr-Ajq_markdownPreview>div h1,.Yr-Ajq_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.Yr-Ajq_markdownPreview>div h2,.Yr-Ajq_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.Yr-Ajq_markdownPreview>div :where(h3,h4,h5,h6),.Yr-Ajq_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.Yr-Ajq_markdownPreview>div :not(pre)>code,.Yr-Ajq_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.Yr-Ajq_markdownPreview>div table,.Yr-Ajq_markdownPayload>div table{font:var(--dsw-font-xs-13)}.Yr-Ajq_markdownPreview>div>:first-child{margin-top:0}.Yr-Ajq_markdownPreview>div>:last-child{margin-bottom:0}.Yr-Ajq_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.Yr-Ajq_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.Yr-Ajq_markdownPreview>div :where(p,ul,ol){margin:8px 0}.Yr-Ajq_markdownPreview>div li:not(:first-child){margin-top:3px}.Yr-Ajq_markdownPreview>div blockquote{margin-top:8px}.Yr-Ajq_markdownPreview>div hr{margin:14px 0}.Yr-Ajq_markdownPreview>div>.md-code-block{margin:10px 0}.Yr-Ajq_assistantContent .Yr-Ajq_markdownPayload,.Yr-Ajq_assistantContent .Yr-Ajq_payload{min-height:0}.Yr-Ajq_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.Yr-Ajq_thinkingQuoteOnlyPreview{margin-bottom:8px}.Yr-Ajq_detailBody>.Yr-Ajq_assistantContentRendered .Yr-Ajq_thinkingQuote{margin-top:14px}.Yr-Ajq_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.Yr-Ajq_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.Yr-Ajq_thinkingToggle[aria-expanded=true] .Yr-Ajq_thinkingChevron{transform:rotate(90deg)}.Yr-Ajq_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.Yr-Ajq_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Yr-Ajq_thinkingQuote .Yr-Ajq_markdownPreview,.Yr-Ajq_thinkingQuote .Yr-Ajq_markdownPayload,.Yr-Ajq_thinkingQuote .Yr-Ajq_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.Yr-Ajq_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.Yr-Ajq_markdownPreview{padding:2px 14px 8px}.Yr-Ajq_markdownPayload{min-height:100%;padding:14px}.Yr-Ajq_jsonPayload{min-height:100%}.Yr-Ajq_jsonPreview{min-height:0}.Yr-Ajq_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.Yr-Ajq_schemaPreview{min-height:0}.Yr-Ajq_schemaIntro{padding:12px 14px 6px}.Yr-Ajq_schemaPreview .Yr-Ajq_schemaIntro{padding-top:2px}.Yr-Ajq_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.Yr-Ajq_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.Yr-Ajq_schemaParameters{min-width:0}.Yr-Ajq_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.Yr-Ajq_schemaTree{margin:0 6px 8px 0}.Yr-Ajq_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.Yr-Ajq_payloadPreview{min-height:0;padding:2px 14px 8px}.Yr-Ajq_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.Yr-Ajq_sourceBlock+.Yr-Ajq_sourceBlock{margin-top:14px}.Yr-Ajq_sourceBlockHeader,.Yr-Ajq_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.Yr-Ajq_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.Yr-Ajq_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.Yr-Ajq_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.Yr-Ajq_sourceBlockJumpTarget:hover .Yr-Ajq_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.Yr-Ajq_sourceBlockJumpTarget:focus-visible{outline:none}.Yr-Ajq_sourceBlockJumpTarget:focus-visible .Yr-Ajq_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.Yr-Ajq_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.Yr-Ajq_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.Yr-Ajq_messageImagesPreview{gap:6px;margin:6px 14px 8px}.Yr-Ajq_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.Yr-Ajq_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.Yr-Ajq_assistantToolCalls li{min-width:0}.Yr-Ajq_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.Yr-Ajq_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Yr-Ajq_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Yr-Ajq_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.Yr-Ajq_assistantToolCallButton:hover .Yr-Ajq_assistantToolCallIcon,.Yr-Ajq_assistantToolCallButton:focus-visible .Yr-Ajq_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.Yr-Ajq_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.Yr-Ajq_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.Yr-Ajq_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Yr-Ajq_systemPrompt{box-sizing:border-box}.Yr-Ajq_toolCatalog{min-height:100%;padding:8px 0 16px}.Yr-Ajq_toolCatalogItem{border-bottom:.5px solid var(--dsw-alias-border-l1)}.Yr-Ajq_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.Yr-Ajq_toolCatalogSummary::-webkit-details-marker{display:none}.Yr-Ajq_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.Yr-Ajq_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Yr-Ajq_toolCatalogChevron,.Yr-Ajq_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.Yr-Ajq_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.Yr-Ajq_toolCatalogItem[open] .Yr-Ajq_toolCatalogChevron{transform:rotate(90deg)}.Yr-Ajq_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.Yr-Ajq_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Yr-Ajq_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.Yr-Ajq_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.Yr-Ajq_toolCatalogTree{margin-left:-14px;margin-right:6px}.Yr-Ajq_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.Yr-Ajq_resultBlocksPreview{gap:6px;min-height:0;padding:2px 14px 8px}.Yr-Ajq_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.Yr-Ajq_overviewPreview .Yr-Ajq_noPayload{padding:2px 14px 0}.Yr-Ajq_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.Yr-Ajq_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "Yr-Ajq_arrow",
			"assistantContent": "Yr-Ajq_assistantContent",
			"assistantContentRendered": "Yr-Ajq_assistantContentRendered",
			"assistantOutput": "Yr-Ajq_assistantOutput",
			"assistantToolCallArgs": "Yr-Ajq_assistantToolCallArgs",
			"assistantToolCallButton": "Yr-Ajq_assistantToolCallButton",
			"assistantToolCallIcon": "Yr-Ajq_assistantToolCallIcon",
			"assistantToolCallName": "Yr-Ajq_assistantToolCallName",
			"assistantToolCallText": "Yr-Ajq_assistantToolCallText",
			"assistantToolCalls": "Yr-Ajq_assistantToolCalls",
			"assistantToolCallsPreview": "Yr-Ajq_assistantToolCallsPreview",
			"assistantVioletBright": "Yr-Ajq_assistantVioletBright",
			"close": "Yr-Ajq_close",
			"collapsedTurnContent": "Yr-Ajq_collapsedTurnContent",
			"collapsedTurnEllipsis": "Yr-Ajq_collapsedTurnEllipsis",
			"collapsedTurnText": "Yr-Ajq_collapsedTurnText",
			"compacted": "Yr-Ajq_compacted",
			"compactedSummary": "Yr-Ajq_compactedSummary",
			"content": "Yr-Ajq_content",
			"contentColumn": "Yr-Ajq_contentColumn",
			"contentText": "Yr-Ajq_contentText",
			"contextGreen": "Yr-Ajq_contextGreen",
			"detailBody": "Yr-Ajq_detailBody",
			"detailBodyProgram": "Yr-Ajq_detailBodyProgram",
			"detailBodySummary": "Yr-Ajq_detailBodySummary",
			"detailTab": "Yr-Ajq_detailTab",
			"detailTabActive": "Yr-Ajq_detailTabActive",
			"detailTabs": "Yr-Ajq_detailTabs",
			"details": "Yr-Ajq_details",
			"detailsHeader": "Yr-Ajq_detailsHeader",
			"detailsLocation": "Yr-Ajq_detailsLocation",
			"detailsResizeHandle": "Yr-Ajq_detailsResizeHandle",
			"detailsTitle": "Yr-Ajq_detailsTitle",
			"error": "Yr-Ajq_error",
			"errorPayload": "Yr-Ajq_errorPayload",
			"event": "Yr-Ajq_event",
			"eventColumn": "Yr-Ajq_eventColumn",
			"eventHeader": "Yr-Ajq_eventHeader",
			"eventInner": "Yr-Ajq_eventInner",
			"history-loading-spin": "Yr-Ajq_history-loading-spin",
			"historyLoadButton": "Yr-Ajq_historyLoadButton",
			"historyLoadRow": "Yr-Ajq_historyLoadRow",
			"historyLoading": "Yr-Ajq_historyLoading",
			"historyLoadingBar": "Yr-Ajq_historyLoadingBar",
			"historyLoadingSpinner": "Yr-Ajq_historyLoadingSpinner",
			"inlineResult": "Yr-Ajq_inlineResult",
			"inlineResultText": "Yr-Ajq_inlineResultText",
			"jsonPayload": "Yr-Ajq_jsonPayload",
			"jsonPreview": "Yr-Ajq_jsonPreview",
			"kindSlot": "Yr-Ajq_kindSlot",
			"kindTag": "Yr-Ajq_kindTag",
			"kindTagIcon": "Yr-Ajq_kindTagIcon",
			"kindTagLabel": "Yr-Ajq_kindTagLabel",
			"markdownPayload": "Yr-Ajq_markdownPayload",
			"markdownPreview": "Yr-Ajq_markdownPreview",
			"message": "Yr-Ajq_message",
			"messageImages": "Yr-Ajq_messageImages",
			"messageImagesPreview": "Yr-Ajq_messageImagesPreview",
			"noOutputText": "Yr-Ajq_noOutputText",
			"noPayload": "Yr-Ajq_noPayload",
			"overview": "Yr-Ajq_overview",
			"overviewHeading": "Yr-Ajq_overviewHeading",
			"overviewHierarchyJumpIconTight": "Yr-Ajq_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "Yr-Ajq_overviewHierarchyNavLink",
			"overviewParentLinks": "Yr-Ajq_overviewParentLinks",
			"overviewPreview": "Yr-Ajq_overviewPreview",
			"overviewSection": "Yr-Ajq_overviewSection",
			"overviewSections": "Yr-Ajq_overviewSections",
			"overviewTitle": "Yr-Ajq_overviewTitle",
			"overviewTitleIcon": "Yr-Ajq_overviewTitleIcon",
			"payload": "Yr-Ajq_payload",
			"payloadPreview": "Yr-Ajq_payloadPreview",
			"programAction": "Yr-Ajq_programAction",
			"programActions": "Yr-Ajq_programActions",
			"programContent": "Yr-Ajq_programContent",
			"programDescription": "Yr-Ajq_programDescription",
			"programError": "Yr-Ajq_programError",
			"programIcon": "Yr-Ajq_programIcon",
			"programLanguage": "Yr-Ajq_programLanguage",
			"programOutput": "Yr-Ajq_programOutput",
			"programPanel": "Yr-Ajq_programPanel",
			"programSource": "Yr-Ajq_programSource",
			"programSummary": "Yr-Ajq_programSummary",
			"promptDiff": "Yr-Ajq_promptDiff",
			"promptDiffLineadded": "Yr-Ajq_promptDiffLineadded",
			"promptDiffLinecontext": "Yr-Ajq_promptDiffLinecontext",
			"promptDiffLinemeta": "Yr-Ajq_promptDiffLinemeta",
			"promptDiffLineremoved": "Yr-Ajq_promptDiffLineremoved",
			"promptDiffSection": "Yr-Ajq_promptDiffSection",
			"promptDiffSections": "Yr-Ajq_promptDiffSections",
			"promptDiffTitle": "Yr-Ajq_promptDiffTitle",
			"requestBoundaryControl": "Yr-Ajq_requestBoundaryControl",
			"requestBoundaryControlActive": "Yr-Ajq_requestBoundaryControlActive",
			"requestDetailsDot": "Yr-Ajq_requestDetailsDot",
			"requestDetailsName": "Yr-Ajq_requestDetailsName",
			"requestTokenDetail": "Yr-Ajq_requestTokenDetail",
			"resultBlockText": "Yr-Ajq_resultBlockText",
			"resultBlocks": "Yr-Ajq_resultBlocks",
			"resultBlocksPreview": "Yr-Ajq_resultBlocksPreview",
			"resultPreview": "Yr-Ajq_resultPreview",
			"resultRequest": "Yr-Ajq_resultRequest",
			"schema": "Yr-Ajq_schema",
			"schemaDescription": "Yr-Ajq_schemaDescription",
			"schemaIntro": "Yr-Ajq_schemaIntro",
			"schemaName": "Yr-Ajq_schemaName",
			"schemaParameters": "Yr-Ajq_schemaParameters",
			"schemaParametersTitle": "Yr-Ajq_schemaParametersTitle",
			"schemaPreview": "Yr-Ajq_schemaPreview",
			"schemaTree": "Yr-Ajq_schemaTree",
			"selectionRail": "Yr-Ajq_selectionRail",
			"sourceBlock": "Yr-Ajq_sourceBlock",
			"sourceBlockContent": "Yr-Ajq_sourceBlockContent",
			"sourceBlockHeader": "Yr-Ajq_sourceBlockHeader",
			"sourceBlockJumpIcon": "Yr-Ajq_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "Yr-Ajq_sourceBlockJumpTarget",
			"sourceBlockLabel": "Yr-Ajq_sourceBlockLabel",
			"sourceBlocks": "Yr-Ajq_sourceBlocks",
			"split": "Yr-Ajq_split",
			"subtoolAmber": "Yr-Ajq_subtoolAmber",
			"summaryScrollRegion": "Yr-Ajq_summaryScrollRegion",
			"systemNeutral": "Yr-Ajq_systemNeutral",
			"systemPrompt": "Yr-Ajq_systemPrompt",
			"table": "Yr-Ajq_table",
			"tablePane": "Yr-Ajq_tablePane",
			"thinkingChevron": "Yr-Ajq_thinkingChevron",
			"thinkingQuote": "Yr-Ajq_thinkingQuote",
			"thinkingQuoteOnlyPreview": "Yr-Ajq_thinkingQuoteOnlyPreview",
			"thinkingToggle": "Yr-Ajq_thinkingToggle",
			"timestampToggle": "Yr-Ajq_timestampToggle",
			"toolAmber": "Yr-Ajq_toolAmber",
			"toolCallNameTypeface": "Yr-Ajq_toolCallNameTypeface",
			"toolCallOnly": "Yr-Ajq_toolCallOnly",
			"toolCallPayload": "Yr-Ajq_toolCallPayload",
			"toolCatalog": "Yr-Ajq_toolCatalog",
			"toolCatalogChevron": "Yr-Ajq_toolCatalogChevron",
			"toolCatalogDefinition": "Yr-Ajq_toolCatalogDefinition",
			"toolCatalogDescription": "Yr-Ajq_toolCatalogDescription",
			"toolCatalogFullDescription": "Yr-Ajq_toolCatalogFullDescription",
			"toolCatalogIcon": "Yr-Ajq_toolCatalogIcon",
			"toolCatalogItem": "Yr-Ajq_toolCatalogItem",
			"toolCatalogName": "Yr-Ajq_toolCatalogName",
			"toolCatalogSummary": "Yr-Ajq_toolCatalogSummary",
			"toolCatalogTree": "Yr-Ajq_toolCatalogTree",
			"trajectory-table": "Yr-Ajq_trajectory-table",
			"turnLabel": "Yr-Ajq_turnLabel",
			"turnLabelActive": "Yr-Ajq_turnLabelActive",
			"turnLabelCompact": "Yr-Ajq_turnLabelCompact",
			"turnLabelFull": "Yr-Ajq_turnLabelFull",
			"turnRail": "Yr-Ajq_turnRail",
			"usageGroup": "Yr-Ajq_usageGroup",
			"usageHeading": "Yr-Ajq_usageHeading",
			"usagePanel": "Yr-Ajq_usagePanel",
			"user": "Yr-Ajq_user",
			"virtualSpacer": "Yr-Ajq_virtualSpacer",
			"visuallyHidden": "Yr-Ajq_visuallyHidden"
		};
		//#endregion
		...
		function RecordListText({ displayText, toolCallOnly, toolCallText, t }) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("span", {
				...
				children: [toolCallText.program && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCodeOutline16, {
		...
		function InspectorCopyButton({ text, label, t }) {
			...
			return (0, react_jsx_runtime.jsx)("button", {
				...
				children: state === "copied" ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCheckOutline16, { size: 12 }) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCopyOutline16, { size: 12 })
			});
		}
			...
			const actions = (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [
					...
					!showJson && (0, react_jsx_runtime.jsx)("button", {
						...
						children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWrapLinesOutline16, { size: 12 })
					}),
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = ".mBBwea_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.mBBwea_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.mBBwea_actions{flex:none;align-items:center;gap:2px;display:flex}.mBBwea_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.mBBwea_toggle:hover,.mBBwea_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.mBBwea_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.mBBwea_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.mBBwea_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.mBBwea_control[hidden]{display:none}.mBBwea_control:hover:not(:disabled),.mBBwea_control[aria-checked=true],.mBBwea_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.mBBwea_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.mBBwea_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.mBBwea_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.mBBwea_controlThumb{corner-shape:round;background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.mBBwea_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.mBBwea_controlTrack[data-on=true] .mBBwea_controlThumb{transform:translate(10px)}.mBBwea_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.mBBwea_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.mBBwea_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.mBBwea_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.mBBwea_search{border:.5px solid var(--dsw-alias-border-l4);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.mBBwea_search:hover{border-color:var(--dsw-alias-label-caption)}.mBBwea_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.mBBwea_searchIcon{flex:none}.mBBwea_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.mBBwea_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.mBBwea_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "mBBwea_action",
			"actionIcon": "mBBwea_actionIcon",
			"actions": "mBBwea_actions",
			"control": "mBBwea_control",
			"controlThumb": "mBBwea_controlThumb",
			"controlTrack": "mBBwea_controlTrack",
			"inner": "mBBwea_inner",
			"root": "mBBwea_root",
			"search": "mBBwea_search",
			"searchIcon": "mBBwea_searchIcon",
			"searchInput": "mBBwea_searchInput",
			"toggle": "mBBwea_toggle",
			"toggleIcon": "mBBwea_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = ".CZjFia_root{z-index:1;isolation:isolate;border-bottom:.5px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.CZjFia_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.CZjFia_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.CZjFia_labels{border-right:.5px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.CZjFia_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.CZjFia_labels span:first-child{top:7px}.CZjFia_labels span:nth-child(2){top:21px}.CZjFia_labels span:nth-child(3){top:35px}.CZjFia_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.CZjFia_track[data-panning=true]{cursor:grabbing}.CZjFia_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.CZjFia_earlierHistory:hover{opacity:1}.CZjFia_earlierHistory[aria-disabled=true]{cursor:default}.CZjFia_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.CZjFia_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.CZjFia_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.CZjFia_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.CZjFia_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.CZjFia_lanes[data-animate-viewport=true],.CZjFia_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.CZjFia_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:.5px;position:absolute}.CZjFia_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.CZjFia_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.CZjFia_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.CZjFia_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.CZjFia_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.CZjFia_span[data-timeline-span=tool],.CZjFia_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.CZjFia_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.CZjFia_span[data-equal-duration=true]{width:8px;min-width:8px}.CZjFia_span[data-selected=false]{opacity:.2}.CZjFia_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.CZjFia_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.CZjFia_span[data-search-match=false]{opacity:.14}.CZjFia_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.CZjFia_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.CZjFia_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.CZjFia_selectionEdges:before,.CZjFia_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.CZjFia_selectionEdges:before{left:0}.CZjFia_selectionEdges:after{right:0}.CZjFia_selectionEdges[data-dragging=true]:before,.CZjFia_selectionEdges[data-dragging=true]:after{width:2px}.CZjFia_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "CZjFia_earlierHistory",
			"empty": "CZjFia_empty",
			"hoverLine": "CZjFia_hoverLine",
			"labels": "CZjFia_labels",
			"lanes": "CZjFia_lanes",
			"plot": "CZjFia_plot",
			"root": "CZjFia_root",
			"selection": "CZjFia_selection",
			"selectionEdges": "CZjFia_selectionEdges",
			"span": "CZjFia_span",
			"track": "CZjFia_track",
			"turnBoundaries": "CZjFia_turnBoundaries",
			"turnBoundary": "CZjFia_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = ".andIKq_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.andIKq_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
