...
export declare const zh: {
    ...
    readonly 'record.wrapLines': "自动换行";
    readonly 'code.source': "代码";
    readonly 'code.output': "输出";
    readonly 'code.copySource': "复制代码";
    readonly 'code.copyOutput': "复制输出";
    readonly 'code.originalJson': "原始 JSON";
    readonly 'code.running': "执行中…";
