window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-open-in-app/src/client/OpenInAppAction.module.css.mjs
		const css = ".JRe2ca_split{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);height:28px;font-family:var(--dsw-font-family);border-radius:14px;align-items:stretch;display:inline-flex;overflow:hidden}.JRe2ca_main,.JRe2ca_chevron{color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;background:0 0;border:0;align-items:center;gap:5px;font-size:11px;font-weight:400;line-height:16px;display:inline-flex}.JRe2ca_main{padding:5px 6px 5px 7px}.JRe2ca_main:hover:not(:disabled),.JRe2ca_main:focus-visible,.JRe2ca_chevron:hover,.JRe2ca_chevron:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.JRe2ca_main:disabled{color:var(--dsw-alias-label-dimmed);cursor:wait}.JRe2ca_main[data-state=error]{color:var(--dsw-alias-state-error-primary);box-shadow:inset 0 0 0 1px var(--dsw-alias-state-error-primary)}.JRe2ca_chevron{border-left:.5px solid var(--dsw-alias-border-l4);color:var(--dsw-alias-label-secondary);padding:5px 6px 5px 4px}.JRe2ca_icon{flex:none}img.JRe2ca_icon{object-fit:contain;user-select:none;display:block}";
