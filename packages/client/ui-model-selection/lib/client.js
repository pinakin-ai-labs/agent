window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/deepak/deepseek-harness/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = "._3FklQG_root{min-width:0;position:relative}._3FklQG_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}._3FklQG_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}._3FklQG_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}._3FklQG_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}._3FklQG_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._3FklQG_triggerEffort{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-caption);flex-shrink:1000;overflow:hidden}._3FklQG_triggerIcon{flex:none;display:none}@container (width<=360px){._3FklQG_triggerIcon{display:block}._3FklQG_triggerLabel,._3FklQG_triggerEffort{display:none}}._3FklQG_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}._3FklQG_chevronOpen{transform:rotate(180deg)}._3FklQG_menu{z-index:1100;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:hidden}._3FklQG_status,._3FklQG_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}._3FklQG_error,._3FklQG_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}._3FklQG_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}._3FklQG_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}._3FklQG_groups{min-height:0;overflow-y:auto}._3FklQG_group+._3FklQG_group{margin-top:4px}._3FklQG_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}._3FklQG_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}._3FklQG_option:hover:not(:disabled),._3FklQG_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}._3FklQG_selected{background:0 0}._3FklQG_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}._3FklQG_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}._3FklQG_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}._3FklQG_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}._3FklQG_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}._3FklQG_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}._3FklQG_cellLabel{white-space:nowrap;flex:none}._3FklQG_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}._3FklQG_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cell": "_3FklQG_cell",
			"cellChevron": "_3FklQG_cellChevron",
			"cellLabel": "_3FklQG_cellLabel",
			"cellValue": "_3FklQG_cellValue",
			"check": "_3FklQG_check",
			"chevron": "_3FklQG_chevron",
			"chevronOpen": "_3FklQG_chevronOpen",
			"empty": "_3FklQG_empty",
			"error": "_3FklQG_error",
			"group": "_3FklQG_group",
			"groupTitle": "_3FklQG_groupTitle",
			"groups": "_3FklQG_groups",
			"menu": "_3FklQG_menu",
			"modelName": "_3FklQG_modelName",
			"option": "_3FklQG_option",
			"optionCopy": "_3FklQG_optionCopy",
			"retry": "_3FklQG_retry",
			"root": "_3FklQG_root",
			"selected": "_3FklQG_selected",
			"status": "_3FklQG_status",
			"trigger": "_3FklQG_trigger",
			"triggerEffort": "_3FklQG_triggerEffort",
			"triggerIcon": "_3FklQG_triggerIcon",
			"triggerLabel": "_3FklQG_triggerLabel",
			"warning": "_3FklQG_warning"
		};
		//#endregion
