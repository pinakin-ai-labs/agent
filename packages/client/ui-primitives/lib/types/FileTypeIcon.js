...
import { CodeFileIcon } from "./CodeFileIcon.js";
import { classifyCodeFileType, isCodeFileType, } from "./code-file-types.js";
 ...
 */
export function classifyFileType(path, context) {
...
export function FileTypeIcon(props) {
    ...
    return isCodeFileType(resolvedType)
        ? _jsx(CodeFileIcon, { type: resolvedType, size: size, className: className })
