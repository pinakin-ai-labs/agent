...
export declare const IconPaperPlaneOutline14: ({ size, className }: IconProps) => import("react").JSX.Element;
/** ic_ds_stop_fill_16 */
...
export declare const IconAlarmClockOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
...
export declare const IconWrapLinesOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
/**
 ...
 */
export declare const IconPlanOutline14: ({ size, className }: IconProps) => import("react").JSX.Element;
/**
 ...
 */
export declare const IconCompactOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
/**
 ...
 */
export declare const SHIELD_OUTLINE_PATH = "M8.20554 0.899994L14.7901 3.36857V7.01026C14.7901 12 11.0466 14.2103 8.20554 15.3C5.36446 14.2103 1.62012 12 1.62012 7.01026V3.36857L8.20554 0.899994Z";
/** Stroke width of {@link SHIELD_OUTLINE_PATH}. */
export declare const SHIELD_OUTLINE_STROKE = "1.31831";
/** Permission row glyph of the composer menu: the shield contour alone, without a mode mark. */
export declare const IconShieldOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
