...
const CODE_FILE_TYPE_SET = new Set(CODE_FILE_TYPES);
 ...
 */
export function isCodeFileType(type) {
 ...
 */
export function isLinkCodeExtension(extension) {
 ...
 */
export function classifyCodeFileType(name, extension, context) {
    ...
    if (extension === 'dart' && context !== undefined) {
        ...
        if (pubspec?.includes('flutter:') === true)
            return 'flutter';
    }
    return EXTENSION_TYPES[extension] ?? null;
}
//# sourceMappingURL=code-file-types.js.map