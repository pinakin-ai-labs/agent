...
import { LinkIcon, classifyLinkPath } from "../LinkIcon.js";
    ...
    switch (node.type) {
        ...
        case 'inlineCode': {
            ...
            if (mention !== undefined) {
                return (_jsx("code", { children: _jsxs("button", { type: "button", className: css.fileMention, title: mention.title, "aria-label": mention.label, onClick: mention.open, children: [_jsx(LinkIcon, { kind: classifyLinkPath(value), className: css.linkIcon }), value] }) }, key));
            }
...
function renderSafeLink(href, children, key, glyph = true) {
    ...
    return (_jsxs("a", { href: safeHref, ...(external ? { target: '_blank', rel: 'noopener noreferrer' } : {}), children: [glyph && _jsx(LinkIcon, { kind: "url", className: css.linkIcon }), children] }, key));
}
