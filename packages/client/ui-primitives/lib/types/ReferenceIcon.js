...
import { IconBrowseOutline16, IconFolderClose16, } from "./icons/index.js";
/**
...
export function ReferenceIcon({ kind, size = 16, className }) {
    switch (kind) {
        ...
        case 'file': return _jsx(IconBrowseOutline16, { size: size, className: className });
        case 'folder': return _jsx(IconFolderClose16, { size: size, className: className });
    }
}
