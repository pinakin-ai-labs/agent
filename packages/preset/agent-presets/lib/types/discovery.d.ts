 ...
 */
export declare function scanRoot(root: PresetRoot, harnessBase: string, resolves?: PackageResolves): Promise<AgentPreset[]>;
/**
 ...
 */
export declare function discoverPresets(roots: readonly PresetRoot[], harnessBase: string, resolves?: PackageResolves): Promise<AgentPreset[]>;
export {};
