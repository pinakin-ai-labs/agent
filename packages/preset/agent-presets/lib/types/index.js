    ...
    return class AgentPresets extends _classSuper {
        ...
        constructor(ctx, config) {
            ...
            ctx.inject(['settings'], (settingsCtx) => {
                this.settings = settingsCtx.settings.register(SETTINGS_NAMESPACE, AgentPresetSettingsSchema, { base: { default: config.default, modeSelectionEnabled: true } });
        ...
        selectionPolicy() {
            ...
            if (settings === undefined)
                return { enabled: true, defaultId: this.config.default };
        ...
        async list() {
            ...
            return packages === undefined
                ...
                : await discoverPresets(this.resolvedRoots, this.harnessBase, (specifier, base) => packages.packageOf(specifier, base) !== undefined);
        }
        /**
