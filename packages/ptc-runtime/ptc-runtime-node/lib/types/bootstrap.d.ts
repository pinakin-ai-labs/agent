 ...
 */
export declare function makeBindingErrorClasses(data: Pick<ProgramBootData, 'namespaces'>): Map<string, BindingErrorConstructor>;
/**
 ...
 */
export declare function makeNamespaces(data: Pick<ProgramBootData, 'namespaces'>, port: BootstrapPort, pending: Map<number, PendingCall>, nextId: {
    value: number;
 ...
 */
export declare function runProgram(port: BootstrapPort, data: ProgramBootData, streams: {
