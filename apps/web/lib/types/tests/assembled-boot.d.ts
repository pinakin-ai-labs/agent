import { type AssembledRemote, type AssembledRemoteOptions } from './assembled-remote.ts';
 ...
 */
export declare function mountAssembledApp(options?: AssembledBootOptions): AssembledRemote;
/**
